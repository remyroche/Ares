...
class RegimeSpecificMultiTimeframeEnsemble:
    ...
    async def run_regime_specific_ensemble_step(self: symbol: str = exchange: str = data_dir: str = timeframe: str = lookback_days: int
    ) -> bool:
    ...
    async def _load_regime_specific_data(self: symbol: str = exchange: str = data_dir: str = lookback_days: int
    ) -> pd.DataFrame:
    ...
    async def _load_regime_timeframe_data(self: symbol: str = exchange: str = timeframe: str = regime: str = lookback_days: int
    ) -> pd.DataFrame:
    ...
    async def _create_regime_timeframe_ensemble(self: regime_data: pd.DataFrame = regime: str = timeframe: str
    ...
    async def _create_regime_multi_timeframe_ensemble(self: regime_ensembles: Dict[str = Any], regime: str
    ) -> Optional[Dict[str = Any]]:
        """Create regime-specific multi-timeframe ensemble."""
    ...
    async def _calculate_regime_specific_weights(self: regime_ensembles: Dict[str = Any], regime: str
    ) -> Dict[str = float]:
    ...
    async def _optimize_regime_ensemble(self: ensemble_results: Dict[str = Any], regime: str = timeframe: str
    ) -> Dict[str = Any]:
    ...
    async def _validate_regime_ensemble(self: ensemble: Dict[str = Any], regime: str
    ) -> bool:
        """Validate regime-specific ensemble."""
    ...
    async def _validate_regime_multi_timeframe_ensemble(self: ensemble: Dict[str = Any], regime: str
    ) -> Dict[str = Any]:
    ...
    async def _perform_regime_validation_checks(self: ensemble: Dict[str = Any], regime: str
...
async def run_step(
    symbol: str = exchange: str = data_dir: str = timeframe: str = "1h",
