...
class EnvironmentSettings(BaseSettings):
    ...
    trading_environment: Literal['LIVE', 'TESTNET', 'PAPER'] = Field(default='PAPER', alias='TRADING_ENVIRONMENT')
    initial_equity: float = Field(default=100.0, alias='INITIAL_EQUITY')
    trade_symbol: str = Field(default='ETHUSDT', alias='TRADE_SYMBOL')
    ...
    monitoring_csv_export_interval_days: int = Field(default=30, alias='MONITORING_CSV_EXPORT_INTERVAL_DAYS')
    monitoring_max_decisions_in_memory: int = Field(default=10000, alias='MONITORING_MAX_DECISIONS_IN_MEMORY')
    monitoring_enable_real_time_updates: bool = Field(default=True, alias='MONITORING_ENABLE_REAL_TIME_UPDATES')
    monitoring_enable_shap: bool = Field(default=True, alias='MONITORING_ENABLE_SHAP')
    monitoring_enable_lime: bool = Field(default=True, alias='MONITORING_ENABLE_LIME')
