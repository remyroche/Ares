...
class EmailCommandListener:
    ...
    def _process_command(self, command: str, sender: str):
        ...
        if command == "ARES KILL SWITCH":
            ...
            self.mailer.send_alert(
                "Trading Resumed",
                f"Trading was resumed by remote command from {sender}.",
            )
    ...
    def _write_flag_file(self, flag_file_path: str):
        ...
        try:
            ...
            self.mailer.send_alert(
                "Flag File Created",
                f"The flag file at {flag_file_path} was created by remote command.",
            )
        except Exception as e:
...
def main_listener_loop():
    ...
    # logger = logging.getLogger("EmailListenerLoop")  # Unused variable removed
