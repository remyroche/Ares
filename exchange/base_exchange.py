...
class BaseExchange(IExchangeClient, ABC):
    ...
    def __init__(self, api_key: str, api_secret: str, trade_symbol: str, password: Optional[str] = None):
        """
    ...
    async def get_historical_klines(
        ...
        Returns:
            List of MarketData objects
        """
        raw_data = await self._get_historical_klines_raw(symbol, interval, start_time_ms, end_time_ms, limit)
        return await self._convert_to_market_data(raw_data, symbol, interval)
    ...
    async def get_historical_agg_trades(
        ...
        """
        return await self._get_historical_agg_trades_raw(symbol, start_time_ms, end_time_ms, limit)
