...
from src.core.di_launcher import DILauncher, launch_paper_trading
...
async def launcher_usage_example():
    ...
    try:
        ...
        if analyst:
            status = await analyst.get_training_status() if hasattr(analyst, "get_training_status") else {}
            print(f"✅ Analyst status: {status}")
        
    except Exception as e:
        print(f"❌ Launcher example failed: {e}")
...
async def custom_factory_example():
    ...
    try:
        ...
        print(f"❌ Custom factory example failed: {e}")
...
async def scope_management_example():
    ...
    try:
        ...
        print(f"❌ Scope management example failed: {e}")
...
async def configuration_injection_example():
    ...
    try:
        ...
        if hasattr(analyst, "config"):
            ...
            print(f"  - Technical analysis: {analyst.config.get('enable_technical_analysis')}")
        
    except Exception as e:
        print(f"❌ Configuration injection example failed: {e}")
