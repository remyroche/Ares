...
class DataCollectionStep:
    ...
    success = await download_all_data_with_consolidation(
                    symbol = symbol = exchange_name = exchange = interval = timeframe = data_dir = data_dir,
                )
    ...
    async def _log_detailed_data_extract(self: symbol: str = exchange: str = timeframe: str = data_dir: str = logger: Any
    ) -> None:
