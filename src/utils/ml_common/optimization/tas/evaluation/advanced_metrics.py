"""
Advanced Evaluation Metrics for TAS

This module provides comprehensive evaluation metrics for tree models including
risk-adjusted returns, regime stability, economic significance, and trading viability.
"""
