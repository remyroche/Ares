...
October 2025 is the earliest honest full-nine-month held fold.  The frozen
Geometry/K9 representation is only out of its October--December 2024 definition
sample from January 2025 onward; testing earlier would require either fewer
than nine months or applying a future representation backward.  Neither was
done.
