...
- **Total Features**: 200
- **Base Features**: 16
- **Interaction Features**: 184
- **Feature Density**: 18.2 features per category
- **Interaction Ratio**: 92.0%

## Category Coverage Analysis
- 🟢 **Trend**: 47 features (Excellent)
- 🟢 **Oscillator**: 51 features (Excellent)
- 🟢 **Momentum**: 39 features (Excellent)
- 🟢 **Returns**: 47 features (Excellent)
- 🟢 **Volatility**: 16 features (Excellent)
...
- **Top 10 features by gain:**
  - `volume_ema_10_base`: 0.0000
  - `vectorbt_smoothed_obv_20_trend_adj`: 0.0000
  - `order_flow_imbalance_20_trend_adj_3x_ratio`: 0.0000
  - `mama_21_0.05_price_returns_vwap_3x_ratio`: 0.0000
  - `macd_delta_12_26_9_base_3x_ratio`: 0.0000
  - `macd_delta_12_26_9_base_6x_ratio`: 0.0000
  - `fibonacci_0.382_20_price_returns_vwap_6x_ratio`: 0.0000
  - `fibonacci_0.5_20_price_returns_base_6x_ratio`: 0.0000
  - `fibonacci_0.382_10_price_returns_vwap_3x_ratio`: 0.0000
  - `fibonacci_0.236_5_price_returns_base_6x_ratio`: 0.0000
...
*Generated on 2025-12-03 00:27:55*
