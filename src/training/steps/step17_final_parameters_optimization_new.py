            ...
            if "confidence" in optimization_results:
                ...
                if "best_value" in confidence_results:
                    ...
                    tactician_results["ml_confidence_factors"] = {
                        "price_deviation_prediction": confidence_results["best_value"].get(
                            "price_deviation_boost", 1.35
                        ),
                        "price_direction_prediction": confidence_results["best_value"].get(
                            "price_direction_boost", 1.28
                        ),
            ...
            if "position_sizing" in optimization_results:
                ...
                if "best_value" in position_results:
                    ...
                    tactician_results["position_monitor"] = {
                        ...
                        "very_low_confidence_threshold": position_results["best_value"].get(
