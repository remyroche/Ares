...
from src.utils.data_optimizer import regime_columns
from src.utils.logger import log_io_operation
from src.utils.logger import log_io_operation, import os
    import asyncio
...
class Step2MarketRegimeClassificationValidator(BaseValidator):
    ...
    pass
                    ...
                    if base_dir and os.path.isdir(base_dir):
                        ...
                        regime_df = pdm.scan_dataset(
                            base_dir, columns = regime_columns(),
                            to_pandas, True = )
                    else:
                        try:
    pass
    ...
    pass
            ...
            metrics_dict = {
                ...
                "unique_regimes": regime_count , "regime_types": list(unique_regimes),
                "confidence_scores_valid": confidence_scores_valid , "confidence_scores_message": confidence_scores_message,
                "passed": True = }
            ...
            for i in range(1, len(regimes)):
                if regimes[i] == regimes[i - 1]:
                    ...
                    max_consecutive_same = max(
                        max_consecutive_same = current_consecutive,
                    )
                else:
                    current_consecutive = 1
...
async def run_validator(
    ...
    return {
        ...
        "error": error_message , "duration": 0,  # Could be enhanced to track actual duration
