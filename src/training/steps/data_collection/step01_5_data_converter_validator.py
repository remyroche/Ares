...
class FunctionCallMonitor:
    ...
    async def _monitor_call(self, func: Callable, args: tuple, kwargs: dict, is_async: bool = False):
    ...
    def _validate_function_inputs(self, func: Callable, args: tuple, kwargs: dict) -> Dict[str, Any]:
        ...
        try:
            ...
            for param_name, param_value in bound_args.arguments.items():
                ...
                # Check for empty collections where not appropriate
    ...
    def _update_performance_metrics(self, call_context: Dict[str, Any]):
    ...
    def get_call_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                'error_count': len(self.error_tracking),
                'performance_metrics': self.performance_metrics.copy(),
                'recent_errors': self.error_tracking[-10:] if self.error_tracking else [],
                'call_stack_depth': max([c['call_depth'] for c in self.call_history]) if self.call_history else 0
            }
...
class HealthCheckSystem:
    ...
    def __init__(self, logger):
        ...
        self.health_checks = {
            ...
            'component_availability': self._check_component_availability,
    ...
    async def _check_data_integrity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'unified_directory_exists': os.path.exists(unified_dir)
            }
    ...
    async def _check_component_availability(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'required_modules_available': len(unavailable_components) == 0
            }
    ...
    async def _check_file_system_health(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check disk I/O performance (basic test)
            data_dir = context.get('data_dir', 'data_cache')
            if os.path.exists(data_dir):
                ...
                return {
                    ...
                    'performance_metrics': {
                        ...
                        'write_speed_mb_per_sec': 0.001 / write_time if write_time > 0 else 0,
                        'read_speed_mb_per_sec': 0.001 / read_time if read_time > 0 else 0
                    }
                }
            else:
                return {
                    ...
                    'issues': [f"Missing data directory: {data_dir}"]
                }
    ...
    async def _check_memory_health(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # If VMS is significantly larger than RSS, it might indicate memory fragmentation
            if vms_mb > rss_mb * 2:
                if status == 'HEALTHY':
                    status = 'WARNING'
            ...
            return {
                ...
                'metrics': {
                    ...
                    'rss_mb': rss_mb,
                    'vms_mb': vms_mb,
                    'memory_fragmentation_ratio': vms_mb / rss_mb if rss_mb > 0 else 0
                }
            }
...
class Step1_5DataConverterValidator(BaseValidator):
    ...
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        # Initialize function call monitor
    ...
    def _apply_function_monitoring(self) -> None:
        ...
        methods_to_monitor = [
            'validate',
            '_check_unified_data_structure',
            '_validate_unified_files',
            '_validate_single_unified_file',
    ...
    async def validate(
        ...
        # Initialize validation artifacts
        ...
        try:
            # Step 0: Run comprehensive health check
            ...
            # Step 1: Check pipeline_state presence first
            ...
            # Step 2: Check for unified data structure
            ...
            if unified_structure["found"]:
                ...
                # Step 3: Validate the unified data files
            ...
            # Generate comprehensive report even on error
            await self._generate_comprehensive_validation_report(validation_artifacts, False)
            return False
        
        finally:
            # Log comprehensive function call report
            self.call_monitor.log_comprehensive_report()
            
            # Update validation artifacts with final metrics
    ...
    async def _validate_single_unified_file(
        ...
        validation_results = {
            ...
            "validation_start_time": file_validation_start,
            "checks_performed": [],
            "checks_passed": [],
            "checks_failed": [],
            "warnings": [],
        ...
        try:
            ...
            try:
                ...
                return {
                    "valid": False,
                    "records": 0,
                    "error": f"File load error: {str(e)}",
                    "validation_details": validation_results
                }

            # Check 3: Minimum records validation
            ...
            if len(df) < self.min_records:
                ...
                validation_results["data_quality_metrics"]["records_validation"] = {
                    "actual": len(df),
                    "minimum_required": self.min_records,
                    "deficit": self.min_records - len(df)
                }
                return {
                    "valid": False,
                    "records": len(df),
            ...
            # Check 4: Required columns validation
            ...
            validation_results["schema_validation"]["required_columns"] = {
                "present": [col for col in self.required_columns if col in df.columns],
                "missing": missing_columns
            }
            validation_results["schema_validation"]["unified_columns"] = {
                "present": [col for col in unified_required if col in df.columns],
                "missing": missing_unified
            }
            ...
            validation_results["schema_validation"]["timestamp_type"] = {
                "is_datetime": ts_is_datetime,
                "is_numeric": ts_is_numeric,
            ...
            # Check 6: Metadata validation (exchange, symbol, timeframe)
            ...
            try:
                if "exchange" in df.columns:
                    ...
                    metadata_validation["exchange"] = {
                        "expected": exchange.upper(),
                        "actual": df_exchange,
                        "match": df_exchange == exchange.upper()
                    }
                ...
                if "symbol" in df.columns:
                    ...
                    metadata_validation["symbol"] = {
                        "expected": symbol,
                        "actual": df_symbol,
                        "match": df_symbol == symbol
                    }
                    if df_symbol != symbol:
                ...
                if "timeframe" in df.columns:
                    ...
                    metadata_validation["timeframe"] = {
                        "expected": timeframe,
                        "actual": df_timeframe,
                        "match": df_timeframe == timeframe
                    }
            ...
            validation_results["data_quality_metrics"]["missing_values"] = {
            ...
            if quality_issues:
                ...
                return {
                    "valid": False,
                    "records": len(df),
                    "error": f"Data quality issues: {'; '.join(quality_issues)}",
                    "validation_details": validation_results
                }
...
async def run_validator(
    ...
    execution_metrics = {
        ...
        'validator_initialization_time': 0,
    ...
    try:
        # Track validator initialization
        init_start = time.time()
        logger.info("🔧 Initializing enhanced validator...")
        # Validator is already initialized above
        ...
        # Execute validation with comprehensive monitoring
        ...
        result = {
            "step_name": "step01_5_data_converter_enhanced",
            "execution_id": execution_id,
            "validation_passed": validation_passed,
            "validation_results": validator.validation_results,
            "execution_metrics": execution_metrics,
            "function_call_summary": execution_metrics['function_call_summary'],
            "duration": execution_metrics['total_execution_time'],
            "timestamp": execution_start_time,
            "memory_usage": {
                "start_mb": execution_metrics['memory_usage_start'],
                "end_mb": execution_metrics['memory_usage_end'],
                "delta_mb": execution_metrics['memory_delta']
            },
            "performance_breakdown": {
                "initialization_time": execution_metrics['validator_initialization_time'],
                "validation_time": execution_metrics['validation_execution_time'],
        ...
        # Return error result with available metrics
        return {
            "step_name": "step01_5_data_converter_enhanced",
            "execution_id": execution_id,
            ...
            "validation_results": {},
            "execution_metrics": execution_metrics,
            "function_call_summary": validator.call_monitor.get_call_summary() if 'validator' in locals() else {},
            "duration": execution_metrics['total_execution_time'],
            "timestamp": execution_start_time,
            "error": str(e),
...
if __name__ == "__main__":
    ...
    async def test_enhanced_validator() -> None:
        ...
        # Test case 1: Successful validation with pipeline state
        ...
        # Test case 2: Validation without pipeline state (will check file system)
        ...
        pipeline_state2 = {}  # Empty pipeline state
