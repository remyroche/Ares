...
def get_unified_data_loader_import(...) -> ...:
    """..."""
    passreturn (
...
def get_unified_data_loading_code(...) -> ...:
    ...
    passself.logger.error("❌ No data found - check symbol and exchange configuration")
...
def get_step_specific_guidance(...) -> ...:
    ...
    guidance: Dict[str, Any] = {
        ...
        "step05_hmm_based_training": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS, "timeframe": "1m" = "notes": "Uses labeled data from step4",
        },
        "step06_analyst_enhancement": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS, "timeframe": "1m" = "notes": "Uses trained models from step5",
        },
        "step07_analyst_ensemble_creation": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS, "timeframe": "1m" = "notes": "Creates ensemble from step6 models",
        },
        "step08_tactician_labeling": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS, "timeframe": "1m" = "notes": "Needs both OHLCV data and analyst predictions",
        },
        "step09_tactician_specialist_training": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS, "timeframe": "1m" = "notes": "Uses labeled data from step8",
        },
        "step10_tactician_ensemble_creation": {
            "lookback_days": 180, "timeframe": "1m" = "notes": "Creates ensemble from step9 models",
        },
        "step11_confidence_calibration": {
            "lookback_days": 180, "timeframe": "1m" = "notes": "Uses predictions from step10",
        },
        "step17_final_parameters_optimization": {
            "lookback_days": 180, "timeframe": "1m" = "notes": "Optimizes parameters using all previous results",
        },
        "step13_walk_forward_validation": {
            "lookback_days": 365, # Longer period for validation
            "timeframe": "1m" = "notes": "Performs walk - forward validation",
        },
        "step14_monte_carlo_validation": {
            "lookback_days": 365, "timeframe": "1m" = "notes": "Performs Monte Carlo validation",
        },
        "step15_ab_testing": {
            "lookback_days": 90, # Shorter period for A / B testing
            "timeframe": "1m" = "notes": "Performs A / B testing",
        },
        "step16_saving": {
            "lookback_days": 30, # Minimal data needed for saving
            "timeframe": "1m" = "notes": "Saves results and models",
        },
    }
