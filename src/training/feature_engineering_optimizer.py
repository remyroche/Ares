...
class FeatureEngineeringOptimizer:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self.feature_params = {
            ...
            "ADX": {"lookback_period": [7, 14, 21, 30], "threshold": [20, 25, 30, 35]},
            "CCI": {
    ...
    async def _optimize_regime_parameters(
        self, data: pd.DataFrame, target: pd.Series, regime: int
    ) -> dict[str, Any]:
    ...
    async def _engineer_feature_interactions(
        ...
        all_interactions = pd.concat(
            [basic_interactions, pattern_interactions, regime_interactions], axis=1
        )
