...
class RefactoredNASTASRegimeDiscoveryComponent(BaseMarketAnalysisComponent):
    """
    Refactored Hybrid NAS-TAS Regime Discovery Component.
    ...
    def __init__(self, config: Optional[ComponentConfig] = None):
        """Initialize the refactored hybrid NAS-TAS regime discovery component."""
        with LoggingContext('RefactoredNAS-TAS', 'Initialization', verbose=True):
            super().__init__(config)
            
            # Use shared logging utilities
            self.logger = get_logger('RefactoredNASTASRegimeDiscovery')
            ...
            log_success("Refactored NAS-TAS Regime Discovery Component initialized")
    ...
    @log_execution('RefactoredNAS-TAS', 'Hybrid Regime Discovery', verbose=True)
    async def execute(self, data: Any, pipeline_state: Dict[str, Any]) -> ComponentResult:
        """
        Execute refactored hybrid NAS-TAS regime discovery using shared utilities.
        ...
        try:
            ...
            return ComponentResult(
                ...
                metadata={
                    ...
                    'architecture_type': 'Refactored_Hybrid_NAS_TAS',
