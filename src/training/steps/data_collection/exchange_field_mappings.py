...
class FieldMapping:
    ...
    timestamp_field: str
EXCHANGE_FIELD_MAPPINGS = {ExchangeType.BINANCE: {'klines': FieldMapping(exchange=ExchangeType.BINANCE, data_type='klines', field_mappings={'timestamp': 'open_time', 'open': 'open', 'high': 'high', 'low': 'low', 'close': 'close', 'volume': 'volume', 'quote_asset_volume': 'quote_asset_volume', 'number_of_trades': 'number_of_trades', 'taker_buy_base_asset_volume': 'taker_buy_base_asset_volume', 'taker_buy_quote_asset_volume': 'taker_buy_quote_asset_volume', 'close_time': 'close_time'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64', 'quote_asset_volume': 'float64', 'number_of_trades': 'int64', 'taker_buy_base_asset_volume': 'float64', 'taker_buy_quote_asset_volume': 'float64', 'close_time': 'int64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=['quote_asset_volume', 'number_of_trades', 'taker_buy_base_asset_volume', 'taker_buy_quote_asset_volume', 'close_time'], timestamp_format='ms', timestamp_field='open_time'), 'aggtrades': FieldMapping(exchange=ExchangeType.BINANCE, data_type='aggtrades', field_mappings={'timestamp': 'T', 'price': 'p', 'quantity': 'q', 'is_buyer_maker': 'm', 'trade_id': 'a'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'bool', 'trade_id': 'int64'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='ms', timestamp_field='T'), 'futures': FieldMapping(exchange=ExchangeType.BINANCE, data_type='futures', field_mappings={'timestamp': 'fundingTime', 'funding_rate': 'fundingRate'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='ms', timestamp_field='fundingTime')}, ExchangeType.COINBASE: {'klines': FieldMapping(exchange=ExchangeType.COINBASE, data_type='klines', field_mappings={'timestamp': 'timestamp', 'open': 'price_open', 'high': 'price_high', 'low': 'price_low', 'close': 'price_close', 'volume': 'volume'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=[], timestamp_format='s', timestamp_field='timestamp'), 'aggtrades': FieldMapping(exchange=ExchangeType.COINBASE, data_type='aggtrades', field_mappings={'timestamp': 'timestamp', 'price': 'price', 'quantity': 'size', 'is_buyer_maker': 'side', 'trade_id': 'trade_id'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'string', 'trade_id': 'int64'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='s', timestamp_field='timestamp'), 'futures': FieldMapping(exchange=ExchangeType.COINBASE, data_type='futures', field_mappings={'timestamp': 'timestamp', 'funding_rate': 'funding_rate'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='s', timestamp_field='timestamp')}, ExchangeType.KRAKEN: {'klines': FieldMapping(exchange=ExchangeType.KRAKEN, data_type='klines', field_mappings={'timestamp': 'time', 'open': 'open', 'high': 'high', 'low': 'low', 'close': 'close', 'volume': 'vol'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=[], timestamp_format='s', timestamp_field='time'), 'aggtrades': FieldMapping(exchange=ExchangeType.KRAKEN, data_type='aggtrades', field_mappings={'timestamp': 'time', 'price': 'price', 'quantity': 'vol', 'is_buyer_maker': 'type', 'trade_id': 'id'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'string', 'trade_id': 'string'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='s', timestamp_field='time'), 'futures': FieldMapping(exchange=ExchangeType.KRAKEN, data_type='futures', field_mappings={'timestamp': 'time', 'funding_rate': 'funding_rate'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='s', timestamp_field='time')}, ExchangeType.GATEIO: {'klines': FieldMapping(exchange=ExchangeType.GATEIO, data_type='klines', field_mappings={'timestamp': 't', 'open': 'o', 'high': 'h', 'low': 'l', 'close': 'c', 'volume': 'v'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=[], timestamp_format='s', timestamp_field='t'), 'aggtrades': FieldMapping(exchange=ExchangeType.GATEIO, data_type='aggtrades', field_mappings={'timestamp': 'time', 'price': 'price', 'quantity': 'amount', 'is_buyer_maker': 'side', 'trade_id': 'id'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'string', 'trade_id': 'string'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='s', timestamp_field='time'), 'futures': FieldMapping(exchange=ExchangeType.GATEIO, data_type='futures', field_mappings={'timestamp': 't', 'funding_rate': 'r'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='s', timestamp_field='t')}, ExchangeType.MEXC: {'klines': FieldMapping(exchange=ExchangeType.MEXC, data_type='klines', field_mappings={'timestamp': 'open_time', 'open': 'open', 'high': 'high', 'low': 'low', 'close': 'close', 'volume': 'volume'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=[], timestamp_format='ms', timestamp_field='open_time'), 'aggtrades': FieldMapping(exchange=ExchangeType.MEXC, data_type='aggtrades', field_mappings={'timestamp': 'T', 'price': 'p', 'quantity': 'q', 'is_buyer_maker': 'm', 'trade_id': 'a'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'bool', 'trade_id': 'int64'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='ms', timestamp_field='T'), 'futures': FieldMapping(exchange=ExchangeType.MEXC, data_type='futures', field_mappings={'timestamp': 'fundingTime', 'funding_rate': 'fundingRate'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='ms', timestamp_field='fundingTime')}, ExchangeType.OKX: {'klines': FieldMapping(exchange=ExchangeType.OKX, data_type='klines', field_mappings={'timestamp': 'ts', 'open': 'o', 'high': 'h', 'low': 'l', 'close': 'c', 'volume': 'vol'}, data_types={'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}, required_fields=['timestamp', 'open', 'high', 'low', 'close', 'volume'], optional_fields=[], timestamp_format='ms', timestamp_field='ts'), 'aggtrades': FieldMapping(exchange=ExchangeType.OKX, data_type='aggtrades', field_mappings={'timestamp': 'ts', 'price': 'px', 'quantity': 'sz', 'is_buyer_maker': 'side', 'trade_id': 'tradeId'}, data_types={'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64', 'is_buyer_maker': 'string', 'trade_id': 'string'}, required_fields=['timestamp', 'price', 'quantity'], optional_fields=['is_buyer_maker', 'trade_id'], timestamp_format='ms', timestamp_field='ts'), 'futures': FieldMapping(exchange=ExchangeType.OKX, data_type='futures', field_mappings={'timestamp': 'fundingTime', 'funding_rate': 'fundingRate'}, data_types={'timestamp': 'int64', 'funding_rate': 'float64'}, required_fields=['timestamp', 'funding_rate'], optional_fields=[], timestamp_format='ms', timestamp_field='fundingTime')}}
