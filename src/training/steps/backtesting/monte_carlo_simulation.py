...
class MonteCarloSimulationStep:
    ...
    async def execute(
        ...
        **kwargs
        ...
        with memory_managed_backtesting("monte_carlo_simulation") as memory_optimizer:
            try:
    ...
    async def _load_data(self) -> pd.DataFrame:
        """Load market data for simulation using unified data loader."""
        ...
        loading_config = DataLoadingConfig(
            ...
            memory_limit_mb=1500.0  # Higher limit for Monte Carlo
        )
