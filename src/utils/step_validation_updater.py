...
class StepValidationUpdater:
        ...
        if hasattr(step_class, 'execute'):
            ...
            async def validated_execute(self, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> Dict[str, Any]:
                ...
                try:
                    ...
                    # Validate output if it contains DataFrame
    ...
    def update_all_steps(self) -> Dict[str, bool]:
        ...
        for step_name in steps_to_update:
            try:
                # Try to import and update the step
    ...
    def get_update_summary(self) -> Dict[str, Any]:
        ...
        return {
            'total_steps_updated': len(self.updated_steps),
            'updated_steps': self.updated_steps,
            'validation_methods_added': [
                '_validate_and_fix_input_data',
                'execute (wrapped with validation)'
            ],
