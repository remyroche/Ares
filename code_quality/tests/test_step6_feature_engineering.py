...
from src.training.steps.step6_feature_engineering import (
    _check_features_cache,
    _create_features_cache_key,
    run_step,
)
from src.training.steps.step6_feature_interaction_engineering import (
...
class TestFeatureInteractionEngine(unittest.TestCase):
    ...
    def test_initialization_without_optimizers(self):
        ...
        assert engine is not None
        assert not engine.use_dynamic_periods
    ...
    def test_calculate_interaction_importance(self):
        ...
        for col in feature_cols:
            ...
            assert isinstance(result[col], int | float)
...
class TestFeatureEngineeringIntegration(unittest.TestCase):
    ...
    async def test_feature_interaction_with_regime_data(self):
        ...
        assert len(regime_interactions) > 0
