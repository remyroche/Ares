...
from src.training.steps.step7_enhanced_matrix_operations import MatrixOperationsStep, run_step
...
class TestMatrixOperationsStep(unittest.TestCase):
    ...
    async def test_perform_matrix_operations_with_manager(self):
        ...
        self.assertIn("pca_components", result)
    ...
    async def test_analyze_feature_relationships(self):
        ...
        # Verify result
        self.assertIsInstance(result, dict)
        self.assertIn("highly_correlated_pairs", result)
        self.assertIn("feature_clusters", result)
    ...
    def test_calculate_feature_statistics(self):
        ...
        self.assertIn("feature_types", stats)
    ...
    async def test_execute_success(self, mock_log_report, mock_log_metrics,
        ...
        self.assertIn("matrix_results", result)
...
class TestMatrixOperationsIntegration(unittest.TestCase):
    ...
    async def test_matrix_operations_pipeline(self):
        ...
        self.assertIsInstance(matrix_results, dict)
        self.assertIn("correlation_matrix", matrix_results)
    ...
    async def test_feature_importance_analysis(self):
        ...
        self.assertIn("highly_correlated_pairs", analysis)
        self.assertGreater(len(analysis["highly_correlated_pairs"]), 0)
