...
class TestMinimalOperations(unittest.TestCase):
    ...
    def test_safe_file_exists(self):
        ...
        self.assertFalse(self.ops.safe_file_exists(test_file))
        
        test_file.write_text("test")
        self.assertTrue(self.ops.safe_file_exists(test_file))
        
        # Test with invalid path
        self.assertFalse(self.ops.safe_file_exists("\0invalid\0path"))
    ...
    def test_safe_lower(self):
        ...
        self.assertEqual(self.ops.safe_lower("HELLO"), "hello")
        self.assertEqual(self.ops.safe_lower(None), "")
        self.assertEqual(self.ops.safe_lower(123), "123")
    
    def test_safe_upper(self):
        """Test safe uppercase conversion."""
        self.assertEqual(self.ops.safe_upper("hello"), "HELLO")
        self.assertEqual(self.ops.safe_upper(None), "")
        self.assertEqual(self.ops.safe_upper(123), "123")
    
    def test_safe_join(self):
        """Test safe string joining."""
        self.assertEqual(self.ops.safe_join(", ", ["a", "b", "c"]), "a, b, c")
        self.assertEqual(self.ops.safe_join(", ", None), "")
        self.assertEqual(self.ops.safe_join("-", [1, 2, None, 3]), "1-2-None-3")
    
    # Type Conversion Tests
    def test_safe_float(self):
        """Test safe float conversion."""
        self.assertEqual(self.ops.safe_float("3.14"), 3.14)
        self.assertEqual(self.ops.safe_float("42"), 42.0)
        self.assertEqual(self.ops.safe_float(42), 42.0)
        self.assertEqual(self.ops.safe_float("invalid", -1.0), -1.0)
        self.assertEqual(self.ops.safe_float(None, 0.0), 0.0)
    
    def test_safe_int(self):
        """Test safe int conversion."""
        self.assertEqual(self.ops.safe_int("42"), 42)
        self.assertEqual(self.ops.safe_int(42.7), 42)
        self.assertEqual(self.ops.safe_int("invalid", -1), -1)
        self.assertEqual(self.ops.safe_int(None, 0), 0)
