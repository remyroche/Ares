"""
Simplified Pipeline Infrastructure

This module provides the new simplified infrastructure for training steps using
MLPipelineOrchestrator and utility-based approaches instead of complex step classes.
