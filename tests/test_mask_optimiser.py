...
def test_phase1_subsample_equivalence():
    ...
    shared = {
        ...
        "mfe_atr": np.ones(100, dtype=np.float32),
        "mae_atr": np.ones(100, dtype=np.float32),
        "tbm_baselines_cache": {
            "1.25_0.5": {"tp_first": np.zeros(100, dtype=np.int8), "sl_first": np.zeros(100, dtype=np.int8)},
            "1.5_0.6": {"tp_first": np.zeros(100, dtype=np.int8), "sl_first": np.zeros(100, dtype=np.int8)},
            "1.75_0.7": {"tp_first": np.zeros(100, dtype=np.int8), "sl_first": np.zeros(100, dtype=np.int8)},
            "2.0_0.9": {"tp_first": np.zeros(100, dtype=np.int8), "sl_first": np.zeros(100, dtype=np.int8)},
            "2.5_1.1": {"tp_first": np.zeros(100, dtype=np.int8), "sl_first": np.zeros(100, dtype=np.int8)},
        },
