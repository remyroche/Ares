...
class Supervisor:
    ...
    def __init__(
        ...
        self.model_manager = ModelManager(
            database_manager=self.db_manager, performance_reporter=self.performance_reporter
        )
        ...
        if (
            ...
            tasks.extend(
                [
                    ...
                    asyncio.create_task(
                        self.strategist.start(), name="Strategist_Task"
                    ),
            ...
            if isinstance(self.trader, PaperTrader):
                tasks.append(
                    asyncio.create_task(
                        self.trader.run_simulation(), name="PaperTrader_Simulation_Task"
                    )
                )
        else:
            self.logger.error(
