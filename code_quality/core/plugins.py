...
from typing import Dict, List, Any, Optional, Protocol, Type, Union
...
class PluginManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.plugins: Dict[str, Union[BaseCodeFixer, BaseCodeAnalyzer]] = {}
        ...
        try:
            ...
            for name, obj in inspect.getmembers(module):
                if (inspect.isclass(obj) and 
                    issubclass(obj, (BaseCodeFixer, BaseCodeAnalyzer)) and
                    obj != BaseCodeFixer and obj != BaseCodeAnalyzer):
    ...
    def register_plugin(self, name: str, plugin: Union[BaseCodeFixer, BaseCodeAnalyzer]) -> None:
        """Register a plugin manually."""
        self.plugins[name] = plugin
        self.logger.info(f"Registered plugin: {name}")
    
    def get_plugin(self, name: str) -> Optional[Union[BaseCodeFixer, BaseCodeAnalyzer]]:
        """Get a plugin by name."""
        return self.plugins.get(name)
    
    def get_all_plugins(self) -> Dict[str, Union[BaseCodeFixer, BaseCodeAnalyzer]]:
