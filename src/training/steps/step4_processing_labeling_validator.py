...
class Step4ProcessingLabelingValidator(BaseValidator):
    ...
    async def validate(
        ...
        labeled_data_passed = await self._validate_labeled_data_outputs(
            symbol=symbol, 
            exchange=exchange, 
            data_dir=data_dir,
        )
        ...
        label_quality_passed = await self._validate_label_quality(
            symbol=symbol, 
            exchange=exchange, 
            data_dir=data_dir,
        )
        ...
        data_balance_passed = await self._validate_data_balance(
            symbol=symbol, 
            exchange=exchange, 
            data_dir=data_dir,
        )
    ...
    @with_tracing_span("step4_validator._validate_labeled_data_outputs", log_args=False)
    @handle_errors(exceptions=(Exception,), default_return=False, context="labeled_data_validation")
    async def _validate_labeled_data_outputs(
        self, 
        symbol: str, 
        exchange: str, 
        data_dir: str,
    ...
    @with_tracing_span("step4_validator._validate_label_quality", log_args=False)
    @handle_errors(exceptions=(Exception,), default_return=False, context="label_quality_validation")
    async def _validate_label_quality(
        self, 
        symbol: str, 
        exchange: str, 
        data_dir: str,
    ...
    @with_tracing_span("step4_validator._validate_data_balance", log_args=False)
    @handle_errors(exceptions=(Exception,), default_return=False, context="data_balance_validation")
    async def _validate_data_balance(
        self, 
        symbol: str, 
        exchange: str, 
        data_dir: str,
...
@handle_errors(exceptions=(Exception,), default_return={"validation_passed": False}, context="step4_validator_run")
