...
class MasterPipelineOrchestrator:
    ...
    def _discover_pipelines(self):
        ...
        pipeline_files = {
            ...
            "enhanced_testing_pipeline": "enhanced_testing_pipeline.py",
            "enhanced_import_fixing_pipeline": "enhanced_import_fixing_pipeline.py",
            "comprehensive_utility_pipeline": "comprehensive_utility_pipeline.py",
