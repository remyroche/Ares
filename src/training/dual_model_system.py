    ...
    async def _make_entry_decision(
        ...
        try:
            ...
            final_conf_agg = aggregate_directional_confidences([
                ...
                {"direction": ("LONG" if tactician_decision.get("should_execute") else "HOLD") if analyst_decision.get("direction") == "LONG" else ("SHORT" if tactician_decision.get("should_execute") else "HOLD"), "confidence": float(tactician_decision.get("confidence", 0.0))},
            ])
