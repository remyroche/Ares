...
@handle_specific_errors( error_handlers={ ValueError: (False, "Invalid modular tactician configuration"), AttributeError: (False, "Missing required tactician parameters"), KeyError: (False, "Missing configuration keys"), }, default_return=False, context="modular tactician initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="tactician configuration loading", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="tactician modules initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="entry monitoring initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="exit monitoring initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="position monitoring initialization", )
...
@handle_specific_errors( error_handlers={ ValueError: (False, "Invalid tactician parameters"), AttributeError: (False, "Missing tactician components"), KeyError: (False, "Missing required tactician data"), }, default_return=False, context="tactician execution", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=False, context="tactician inputs validation", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="entry monitoring", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="exit monitoring", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="position monitoring", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="tactician results storage", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="tactician results getting", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return=None, context="tactician history getting", )
...
@handle_errors( exceptions=(Exception,), default_return=None, context="modular tactician cleanup", )
...
@handle_errors( exceptions=(Exception,), default_return=None, context="modular tactician setup", )
