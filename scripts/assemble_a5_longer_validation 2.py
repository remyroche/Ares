...
def main() -> None:
    ...
    manifest = {
        ...
        "warmup_note": (
            "The supplied ledger includes April-December 2024 warm-up history, "
            "so the full nine-month history contract is available from the "
            "January 2025 producer cutoff. Pre-2025 rows are calibration/training "
            "history and are not reported as executable 2024 performance."
        ),
