...
class ModelSpecificPruning:
    ...
    def prune_for_neural_networks(
        ...
        try:
            ...
            self.logger.error(f"❌ Neural network pruning failed: {e}")
            raise
    ...
    def prune_for_linear_models(
        ...
        try:
            ...
            self.logger.error(f"❌ Linear model pruning failed: {e}")
            raise
    ...
    def prune_for_ensemble_models(
        ...
        try:
            ...
            self.logger.error(f"❌ Ensemble model pruning failed: {e}")
            raise
    ...
    def prune_for_step6_5_unified_regime(
        ...
        try:
            ...
            self.logger.error(f"❌ Step 6.5 pruning failed: {e}")
            raise
    ...
    def prune_for_step7_ensemble(
        ...
        try:
            ...
            self.logger.error(f"❌ Step 7 pruning failed: {e}")
            raise
    ...
    def _remove_redundant_features(self, features_df: pd.DataFrame, target: pd.Series) -> List[str]:
        ...
        diverse_features = self._remove_highly_correlated_features(features_df[top_features], threshold=0.9)
