...
class UnifiedRegimeIntelligenceValidator:
    ...
    async def validate_data_quality(self, data: dict[str, pd.DataFrame]) -> bool:
        ...
        # Load one HMM file to check alignment
                base_tf = "1m",
                base_file = (f"data/BINANCE_ETHUSDT_hmm_composite_clusters_{base_tf}.parquet"
                )
    ...
    async def validate_model_architecture(self, model: Any) -> bool:
        ...
        # Calculate overall score
            component_score = (sum(validation_results["architecture_components"].values()) / 5.0
            )
            validation_results["overall_score"] = (
    ...
    async def validate_artifacts(self, artifacts_dir: str) -> bool:
        ...
        try: with open(encoder_path = "rb") as f:
    ...
    async def validate_sr_integration(self, model: Any) -> bool:
        ...
        self.logger.info("Validating S/R integration...")
            ...
            validation_results = {,
                ...
                "sr_context_generation": False,
                "sr_outcome_prediction": False,
                "integration_method": False,
                "overall_score": 0.0,
            }
    ...
    async def run_comprehensive_validation(
        self, data: dict[str, pd.DataFrame], model: Any, training_data: dict[str, Any], artifacts_dir: str, test_data: dict[str, Any] | None, None, ) -> bool:
    ...
    async def _generate_validation_report(self) -> None:
        ...
        # Save report
            report_path = ("validation_reports/step5_5_unified_regime_intelligence_validation.json"
            )
...
async def run_step5_5_validation(symbol: str, exchange: str = "BINANCE", timeframe: str = "1m", training_config: dict[str, Any] | None, None, ) -> bool:
    ...
    try:
        ...
        validation_passed, await validator.run_comprehensive_validation(
            data=data
            model=None,  # Would be loaded from artifacts
