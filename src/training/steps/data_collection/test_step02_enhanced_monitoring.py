...
from src.training.steps.data_collection.step02_data_reading import (
    DataReadingStep,
    function_monitor,
...
from src.training.steps.data_collection.step02_data_reading_validator import (
    run_validator,
    generate_validation_function_report
)
...
class Step02EnhancedMonitoringTester:
    ...
    async def test_function_call_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Create DataReadingStep instance
            ...
            test_passed = (
                ...
                function_report.total_calls > 0 and
                function_report.successful_calls > 0 and
                'function_interaction_report' in result
            )
    ...
    async def test_function_interaction_tracking(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Test with a simple function that calls other functions
            @comprehensive_function_monitoring(
            ...
            test_passed = (
                function_report.total_calls >= 3 and  # parent + 2 children
                len(function_report.call_hierarchy) > 0 and
                function_report.performance_metrics.get('max_call_depth', 0) > 0
            )
    ...
    async def test_error_handling_and_recovery(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_passed = (
                ...
                function_report.failed_calls > 0 and
                len(function_report.error_summary) > 0 and
                result1 == 10
            )
            ...
            return {
                ...
                'passed': test_passed,
                'function_report': function_report,
                'error_test_passed': error_test_passed
            }
    ...
    async def test_performance_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Test function with different performance characteristics
            @comprehensive_function_monitoring(
                validate_inputs=True,
                validate_outputs=True,
                track_performance=True,
            ...
            await test_performance_function(0.01)  # Fast
            await test_performance_function(0.1)   # Medium
            await test_performance_function(0.05)  # Medium-fast
            ...
            test_passed = (
                function_report.total_calls == 3 and
                function_report.performance_metrics.get('fastest_call') is not None and
                function_report.performance_metrics.get('slowest_call') is not None and
                function_report.performance_metrics.get('median_execution_time', 0) > 0
            )
    ...
    async def test_validation_framework_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generate validation function report
            report_result = await generate_validation_function_report(
                training_input, validation_result, str(self.temp_dir)
            )
            ...
            test_passed = (
                validation_result.get('validation_passed', False) and
                report_result.get('success', False) and
                function_report.total_calls > 0 and
                'validation_monitoring' in str(report_result.get('report_path', ''))
            )
            ...
            return {
                'test_name': 'validation_framework_integration',
                'passed': test_passed,
    ...
    async def run_all_tests(self) -> Dict[str, Any]:
        ...
        test_methods = [
            self.test_function_call_monitoring,
            self.test_function_interaction_tracking,
            self.test_error_handling_and_recovery,
            self.test_performance_monitoring,
            self.test_validation_framework_integration
        ]
