...
This module provides the main interface for generating probability outputs for trained
models. It coordinates the probability calculation framework to generate all 4 required
