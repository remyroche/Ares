...
class EnhancedHMMBasedTrainingStep:
    ...
    async def _load_regime_specific_data(self: symbol: str = data_dir: str = regime: str
    ) -> pd.DataFrame:
    ...
    async def _train_regime_specific_model(self: regime_data: pd.DataFrame = regime: str = config: dict
    ) -> Dict[str = Any]:
    ...
    async def _engineer_regime_features(self: regime_data: pd.DataFrame = regime: str
    ) -> pd.DataFrame:
    ...
    async def _optimize_regime_hyperparameters(self: regime_features: pd.DataFrame = regime: str
    ) -> Dict[str = Any]:
    ...
    async def _train_model_with_regime_params(self: regime_features: pd.DataFrame = regime_params: dict = regime: str
    ) -> Any:
    ...
    async def _validate_regime_model(self: regime_model: Any = regime_features: pd.DataFrame = regime: str
    ) -> Dict[str = Any]:
    ...
    async def _perform_regime_specific_validation(self: regime_model: Any = regime_features: pd.DataFrame = regime: str
    ) -> Dict[str = Any]:
    ...
    async def run_enhanced_regime_specific_step(self: symbol: str = data_dir: str = method_a_mixture_of_experts: dict = enable_multi_output: bool
    ) -> bool:
    ...
    async def prepare_enhanced_data(self: data: pd.DataFrame = timeframe: str = regime_key: Optional[str], None
    ) -> Dict[str = Any]:
    ...
    @performance_monitor
    async def train_enhanced_model(self: prepared_data: Dict[str = Any],
    ...
    async def _train_single_output_model(self: features: pd.DataFrame = target: pd.Series = timeframe: str = regime_key: Optional[str], None
    ) -> Dict[str = Any]:
    ...
    async def train_enhanced_regime_specific_models(self: timeframe: str = regime_data: Dict[str = Any]
    ) -> Dict[str = Any]:
    ...
    def save_enhanced_models(self: results: Dict[str = Any],
        save_path: str
    ) -> None:
    ...
    def load_enhanced_models(self: model_name: str = load_path: str
    ) -> None:
