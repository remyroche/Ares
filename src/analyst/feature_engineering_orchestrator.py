...
class FeatureEngineeringOrchestrator:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.enable_advanced_features = self.orchestrator_config.get("enable_advanced_features", True)
        self.enable_autoencoder_features = self.orchestrator_config.get("enable_autoencoder_features", True)
        self.enable_legacy_features = self.orchestrator_config.get("enable_legacy_features", True)
        ...
        try:
            ...
            if self.enable_advanced_features:
                ...
                features_df = self.advanced_feature_engineering.generate_features(
                    features_df, agg_trades_df, futures_df
                )
    ...
    def _calculate_volatility_targeting_features(
        ...
        try:
            ...
            # Volatility regime
            df['vol_regime'] = np.where(df['vol_target_ratio'] > 1.5, 'high_vol',
...
class FeatureEngineeringEngine:
    ...
    def generate_all_features(
        ...
        """
        return self.orchestrator.generate_all_features(
            klines_df, agg_trades_df, futures_df, sr_levels
        )
