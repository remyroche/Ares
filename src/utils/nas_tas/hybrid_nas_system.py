...
class HybridNASSystem:
    ...
    def _calculate_tabular_ratio(self, X: np.ndarray) -> float:
        ...
        try:
            ...
            tprint_warning(f"⚠️ Failed to calculate tabular ratio: {e}")
    ...
    def _calculate_sequential_ratio(self, X: np.ndarray) -> float:
        ...
        try:
            ...
            tprint_warning(f"⚠️ Failed to calculate sequential ratio: {e}")
    ...
    def _calculate_complexity_ratio(self, X: np.ndarray) -> float:
        ...
        try:
            ...
            tprint_warning(f"⚠️ Failed to calculate complexity ratio: {e}")
            return 0.5  # Default assumption
    ...
    def _calculate_sparsity(self, X: np.ndarray) -> float:
        ...
        try:
            ...
            tprint_warning(f"⚠️ Failed to calculate sparsity: {e}")
            return 0.0
