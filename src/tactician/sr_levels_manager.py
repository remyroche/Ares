...
class SRLevelsManager:
    ...
    async def calculate_sr_levels_from_backtest(
        self, market_data: pd.DataFrame, timeframe: str = "1m"
    ...
    async def calculate_sr_levels_with_method(
        self, market_data: pd.DataFrame, method: str, level_type: str = "both"
    ) -> Dict[str, List[SRLevel]]:
        """Calculate SR levels using a specific detection method from SR breakout
        predictor.
    ...
    def compare_price_vs_vwap_predictions(
        self, price_levels: List[SRLevel], vwap_levels: List[SRLevel]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            comparison = {
                ...
                "quality_metrics": {"price": price_quality, "vwap": vwap_quality},
