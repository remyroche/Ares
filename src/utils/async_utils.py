...
@handle_specific_errors( error_handlers={ ValueError: (False, "Invalid async file manager configuration"), AttributeError: (False, "Missing required file parameters"), KeyError: (False, "Missing configuration keys"), }, default_return = False, context="async file manager initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="file configuration loading", )
...
@handle_file_operations( default_return = None, context="file reading", )
...
@handle_file_operations( default_return = False, context="file writing", )
...
@handle_file_operations( default_return = None, context="JSON file reading", )
...
@handle_file_operations( default_return = False, context="JSON file writing", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="cache management", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="cache clearing", )
...
@handle_errors( exceptions=(Exception,), default_return = None, context="async file manager cleanup", )
...
@handle_specific_errors( error_handlers={ ValueError: (False, "Invalid async task manager configuration"), AttributeError: (False, "Missing required task parameters"), KeyError: (False, "Missing configuration keys"), }, default_return = False, context="async task manager initialization", )
async def initialize(self) -> bool:
        """
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="task configuration loading", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="task execution", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = False, context="task cancellation", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="all tasks cancellation", )
...
@handle_errors( exceptions=(Exception,), default_return = None, context="async task manager cleanup", )
async def stop(self) -> None:
...
@handle_errors( exceptions=(Exception,), default_return = None, context="async utils setup", )
