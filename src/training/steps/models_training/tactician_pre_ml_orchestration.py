    ...
    async def orchestrate(
        ...
        **kwargs
        ...
        try:
            ...
            # Create precomputed entry labels before invoking the sub-pipeline
            ...
            if entry_label_bundle:
                tprint_success("✅ Differentiated entry labels created from Analyst green lights")
                ...
                tprint_warning("⚠️ Differentiated entry labels not created; pipeline will fall back to standard labeling")
