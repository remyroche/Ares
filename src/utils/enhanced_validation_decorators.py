        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                if validate_prerequisites and validator:
                    context.start_validation("prerequisites")
                ...
                if validate_inputs and validator:
                    context.start_validation("inputs")
                ...
                if validate_outputs and validator:
                    context.start_validation("outputs")
                ...
                if validate_data_quality and validator:
                    context.start_validation("data_quality")
...
def validate_step1_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 1."""
...
def validate_step1_5_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 1.5."""
    return comprehensive_step_validation(
...
def validate_step2_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 2."""
    return comprehensive_step_validation(
        "step02_data_reading",
        validate_prerequisites=True,
        validate_inputs=True,
...
def validate_step3_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 3."""
    return comprehensive_step_validation(
...
def validate_step5_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 5."""
    return comprehensive_step_validation(
        "step05_labeling",
        validate_prerequisites=True,
        validate_inputs=True,
...
def validate_step6_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 6."""
    return comprehensive_step_validation(
...
def validate_step7_comprehensive(func: Callable) -> Callable:
    """Comprehensive validation for step 7."""
    return comprehensive_step_validation(
...
def _extract_validator_instance(args: tuple, kwargs: dict) -> Optional[BaseValidator]:
    """Extract validator instance from function arguments."""
...
def _handle_validation_failure_sync(
    ...
    """Handle validation failure synchronously."""
    # For now, log the failure and continue with original function
    # In production, you might want to raise an exception or take other action
    system_logger.warning(f"Validation failed but continuing with {func.__name__}: {validation_result}")
    return func(*args, **kwargs)

def _log_validation_performance(context: ValidationContext, logger: logging.Logger, log_level: str):
...
__all__ = [
    ...
    "ValidationContext",
    "validate_with_base_validator",
    "smart_validation_cache",
    "validate_step1_comprehensive",
    "validate_step1_5_comprehensive",
    "validate_step2_comprehensive",
    "validate_step3_comprehensive",
    "validate_step4_comprehensive",
    "validate_step5_comprehensive",
    "validate_step6_comprehensive",
    "validate_step7_comprehensive"
]