...
class MLTacticsManager:
    ...
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        self.confidence_threshold: float = self.ml_config.get("confidence_threshold", 0.7)
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if not self._validate_configuration():
                self.logger.error("Invalid configuration for ML tactics manager")
                return False
            ...
            self.logger.error(f"❌ ML Tactics Manager initialization failed: {e}")
            return False
    ...
    def _validate_configuration(self) -> bool:
        ...
        try:
            if self.confidence_threshold <= 0 or self.confidence_threshold > 1:
                self.logger.error("Invalid confidence_threshold configuration")
                return False
                
            if self.regime_threshold <= 0 or self.regime_threshold > 1:
                self.logger.error("Invalid regime_threshold configuration")
                return False
    ...
    async def execute_ml_tactics(
        ...
        try:
            ...
            if not ml_predictions:
                self.logger.warning("⚠️ No ML predictions available")
                return {}
            ...
            self.logger.error(f"❌ ML tactics execution failed: {e}")
            return {}
    ...
    def _validate_tactics_input(self, tactics_input: dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.logger.error(f"ML tactics input validation failed: {e}")
            return False
    ...
    def _apply_regime_and_location_tactics(
        ...
        try:
            ...
            return {
                ...
                "combined_tactics": self._combine_regime_location_tactics(regime_tactics, location_tactics),
            }
            
        except Exception as e:
            self.logger.error(f"❌ Regime and location tactics application failed: {e}")
            return {}
    ...
    def _make_ml_entry_decisions(
        ...
        try:
            ...
            self.logger.error(f"❌ ML entry decisions making failed: {e}")
            return {}
    ...
    def _make_ml_sizing_decisions(
        ...
        try:
            ...
            self.logger.error(f"❌ ML sizing decisions making failed: {e}")
            return {}
    ...
    def _make_ml_leverage_decisions(
        ...
        try:
            ...
            self.logger.error(f"❌ ML leverage decisions making failed: {e}")
            return {}
    ...
    def _make_ml_directional_decisions(
        ...
        try:
            ...
            self.logger.error(f"❌ ML directional decisions making failed: {e}")
            return {}
    ...
    def _make_ml_liquidation_risk_decisions(
        ...
        try:
            ...
            self.logger.error(f"❌ ML liquidation risk decisions making failed: {e}")
            return {}
    ...
    async def stop(self) -> None:
        ...
        try:
            ...
            self.logger.error(f"❌ Failed to stop ML Tactics Manager: {e}")
...
async def setup_ml_tactics_manager(
    ...
    try:
        ...
        system_logger.error(f"Failed to setup ML tactics manager: {e}")
        return None 