#!/usr/bin/env python3
"""
Fixed Import Analyzer - Properly handles parent module imports.
"""
...
class FixedImportAnalyzer:
    """Fixed analyzer that properly handles parent module imports."""
        ...
        for utils_file in utils_files:
            ...
            for other_file, other_imports in all_imports.items():
                if other_file != file_path_str:
                    if self._is_module_imported_fixed(module_name, other_imports):
    ...
    def _is_module_imported_fixed(self, module_name: str, imports: Set[str]) -> bool:
        """
        FIXED: Check if a module is imported with proper parent module handling.
        """
        # Direct exact match
        ...
        # FIXED: Check if this module is imported as a parent module
        # e.g., if module_name = "src.utils.sr_clustering.backtesting_enhanced_clustering"
        # and imports contains "src.utils.sr_clustering", then this module is imported
    ...
    def print_detailed_report(self, results: Dict[str, Any]) -> None:
        ...
        print("\n" + "="*80)
        print("FIXED DEAD CODE ANALYSIS REPORT - src/utils/")
        print("="*80)
