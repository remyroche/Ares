...
class MissingDataDownloaderAndGapFiller:
    ...
    def identify_missing_data(self, symbol: str, exchange: str, end_date: datetime | None = None) -> dict:
    ...
    async def download_missing_aggtrades(self, symbol: str, exchange: str, missing_days: list[datetime]) -> dict:
    ...
    async def fill_single_gap(self, symbol: str, exchange: str, gap_info: dict) -> dict:
