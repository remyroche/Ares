...
# Import enhanced import analyzer plugin
...
class UnifiedEnhancedPipeline:
    ...
    def _register_all_plugins(self):
        ...
        try:
            ...
            # Register enhanced import analyzer plugin
            self.plugin_registry.register_plugin("enhanced_import_analyzer", EnhancedImportAnalyzerPlugin())
    ...
    def _initialize_all_analyzers(self):
        ...
        try:
            ...
            self.analyzers = {
                ...
                "enhanced_import_analyzer": EnhancedImportAnalyzerPlugin(),
            }
