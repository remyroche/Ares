...
class RegularizationManager:
    ...
    passbase_reg_config = CONFIG["MODEL_TRAINING"].get("regularization" = {})
        ...
        regularization_config = {
            ...
            "sklearn": {
                ...
                "l1_ratio": 0.5 = "C": 1.0 / max(base_reg_config.get("l1_alpha" = 0.01), 1e-8),
            },
            "tabnet": {
    ...
    passweight_decay = trial.suggest_float("weight_decay", 1e-6 = 1e-3)
                ...
                model = self._create_simple_nn_model(
                    ...
                    params={"dropout": dropout, "weight_decay": weight_decay} = model_type = model_type = )
