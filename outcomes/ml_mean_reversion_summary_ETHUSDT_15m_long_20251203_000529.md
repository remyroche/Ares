...
**VAL**: ACC=0.3934, F1=0.3211, Precision=0.4861, Recall=0.2397, AUC=0.4661, LogLoss=0.8455
**TEST**: ACC=0.4398, F1=0.4771, Precision=0.4622, Recall=0.4929, AUC=0.3926, LogLoss=0.8375

### Calibrated Model Performance

**TRAIN**: ACC=0.0000, F1=0.0000, Precision=0.0000, Recall=0.0000, AUC=0.0000, LogLoss=0.0000
**VAL**: ACC=0.5984, F1=0.7487, Precision=0.5984, Recall=1.0000, AUC=0.5240, LogLoss=0.6633
**TEST**: ACC=0.5184, F1=0.6828, Precision=0.5184, Recall=1.0000, AUC=0.5071, LogLoss=0.6886
