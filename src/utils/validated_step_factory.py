...
class ValidatedStepFactory:
    ...
    def __init__(self):
        ...
        # Define validation schemas for different step types
        self.step_schemas = {
            'data_reading': 'unified',
            'sr_optimization': 'unified', 
            'hmm_regime_discovery': 'unified',
            'regime_data_splitting': 'unified',
            'labeling': 'unified',
            'feature_engineering': 'unified',
            'matrix_operations': 'unified',
            'feature_selection': 'unified',
            'hmm_training': 'unified',
            'regime_intelligence': 'unified',
            'analyst_creation': 'unified',
            'analyst_enhancement': 'unified',
            'analyst_ensemble': 'unified',
            'tactician_labeling': 'unified',
            'tactician_training': 'unified',
            'confidence_calibration': 'unified',
            'parameter_optimization': 'unified',
            'walk_forward_validation': 'unified',
            'monte_carlo_validation': 'unified',
            'ab_testing': 'unified',
            'model_persistence': 'unified'
        }
    ...
    def create_validated_step(self, step_class: Type, step_name: str, step_type: str = None) -> Type:
        ...
        class ValidatedStep(step_class):
            def __init__(self, *args, **kwargs):
                ...
                # Add standards to the step if not already present
            ...
            async def execute(self, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> Dict[str, Any]:
                ...
                if not pre_validation['passed']:
                    ...
                    return {
                        'success': False,
                        'error': f"Pre-execution validation failed: {pre_validation['issues']}",
                        'step_name': self.validated_step_name
                    }
                ...
                try:
                    ...
                    # Post-execution validation and fixes
            ...
            def _step_specific_pre_validation(self, data: pd.DataFrame, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> Dict[str, Any]:
                ...
                if self.step_type == 'labeling':
                    # Ensure required columns for labeling
                    ...
                    # Ensure sufficient data for feature engineering
                    if len(data) < 100:
                        validation_result['passed'] = False
                    ...
                    # Ensure regime discovery results are available
    ...
    def _determine_step_type(self, step_name: str) -> str:
        ...
        if 'data_reading' in step_name:
            ...
            return 'unified'  # Default schema
    
    def get_validation_summary(self) -> Dict[str, Any]:
        """Get summary of validation activities."""
        return {
            'total_validated_steps': len(self.step_schemas),
            'available_schemas': list(self.step_schemas.keys()),
