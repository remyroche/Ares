...
- Type of file - Type of strings, boolean values, etc.
...
class ComprehensiveFileValidator:
    ...
    def validate_file_format(self, file_path: str, expected_schema: Optional[str] = None, step_name: str = "") -> FileValidationResult:
