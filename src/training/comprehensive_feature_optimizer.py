...
class ComprehensiveFeatureOptimizer:
    """Comprehensive feature optimizer that generates all feature types using optimized
    lookback periods from matrix optimization."""
    ...
    def _select_top_features(
        ...
        top_features = [
            feature_series for _, feature_series, _ in correlations[:max_features]
        ]
