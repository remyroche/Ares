"""Step 04: Regime Data Splitting - Refactored to use BaseStep.

This module implements regime data splitting functionality.
"""
...
class RegimeDataSplittingStep(BaseStep):
    """Step 04: Regime Data Splitting using standardized base class."""
