...
class AnalystEnsembleTrainingStep(EnsembleTrainingStep):
    ...
    def _create_mock_base_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            mock_models = {
                'tft_model': RandomForestRegressor(n_estimators=10, random_state=42, max_depth=5),
                'tabnet_model': RandomForestRegressor(n_estimators=10, random_state=43, max_depth=5),
                'hist_gb_model': GradientBoostingRegressor(n_estimators=10, random_state=44, max_depth=3),
                'extratrees_model': RandomForestRegressor(n_estimators=10, random_state=45, max_depth=5),
