...
FEATURE_FAMILY_REGISTRY: Dict[str, Set[str]] = {
    FeatureFamily.ALREADY_STANDARDIZED: {
        ...
        "atr_expansion_z", "coherence_24_z", "overext_surprise",
    ...
    FeatureFamily.RISK_NORMALIZED_CONTINUOUS: {
        ...
        "trend_t", "convexity_t", "convexity_bis_t", "breakout_t", "impulse_speed", "impulse_acceleration",
        ...
        "atr_pct_base", "rv_24h", "rv_12h", "rv_8h", "rv_6h", "rv_4h", "rv_2h",
    ...
    FeatureFamily.BOUNDED_GEOMETRY: {
        ...
        "dist_ema50_atr", "ema50_slope", "prior_volatility", "trend_acceleration",
        ...
        "volatility_asymmetry", "down_up_vol_ratio_24", "tail_against", "asym_ratio", "asym_ft",
        "choppiness_index_20"
    },
    FeatureFamily.CATEGORICAL_OR_BUCKETED: {
        ...
        "G_EXH_EFFORT", "G_EXH_GIVEBACK", "G_EXH_TAIL_FAIL", "G_MR_SPIKE", "G_TF_TREND",
        "G_META_EXH",
        "is_trending", "is_ranging", "is_high_vol_regime", "is_low_vol_regime", "vol_regime_switch_12h", "trend_regime_switch_12h",
        "trend_age_hours", "trend_regime_duration_4d", "higher_highs_count_48h", "rejection_bar_count",
        "adx_7_gt25", "adx_10_gt25", "adx_14_gt25", "meta_alignment", "mtf_divergence", "vol_price_diverge",
