...
class SRDetectionOptimizer:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        # S/R predictor instance for testing
            ...
            for i, params in enumerate(self._generate_parameter_combinations(param_ranges)):
                ...
                if score > best_score:
                    ...
                    best_result = OptimizationResult(
                        ...
                        market_regime="", # Placeholder, will be updated
    ...
    def get_optimized_parameters(self) -> Optional[Dict[str, Any]]:
        ...
        if self.current_optimization:
            return {
                ...
                "timeframe_weights": self.current_optimization.timeframe_weights,
                "advanced_params": self.current_optimization.advanced_params,
            }
        return None
