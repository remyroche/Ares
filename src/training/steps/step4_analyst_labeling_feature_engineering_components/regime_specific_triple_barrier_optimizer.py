...
class RegimeSpecificTripleBarrierOptimizer:
    ...
    async def optimize_regime_specific_parameters(self: regime_data: Dict[str = pd.DataFrame],
    ...
    async def _update_triple_barrier_labeler(self: regime_name: str = regime_result: Dict[str = Any]):
        ...
        await self.triple_barrier_labeler.set_regime_parameters(
                    regime_name = regime_name = barrier_settings = barrier_settings = labeling_settings = labeling_settings = position_settings = position_settings = risk_settings = risk_settings
                )
    ...
    async def _create_regime_study(self: regime_name: str = optimization_config: Dict[str = Any]
    ) -> optuna.Study:
    ...
    async def _optimize_single_regime(self: regime_name: str = regime_data: pd.DataFrame = study: optuna.Study = optimization_config: Dict[str = Any]
    ) -> Dict[str = Any]:
    ...
    def _sample_regime_parameters(self: trial: optuna.Trial = regime_config: Dict[str = Any]
    ) -> Dict[str = Any]:
        """Sample parameters from regime - specific configuration."""
    ...
    def _evaluate_regime_parameters(self: regime_name: str = regime_data: pd.DataFrame = params: Dict[str = Any]
    ) -> float:
    ...
    def _calculate_regime_performance_score(self: regime_name: str = barrier_params: Dict[str = Any], labeling_params: Dict[str = Any],
    ...
    async def _create_regime_model(self: regime_name: str = optimized_params: Dict[str = Any]
    ) -> Dict[str = Any]:
