...
class MarketRegime:
    ...
    def __init__(self, name: str, volatility: float, trend_strength: float, 
                 regime_type: str, optimal_params: Dict[str, Any]):
        self.name = name
...
class AdaptiveOptimizer:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.regime_detection_config = config.get("regime_detection", {
            "lookback_window": 50,
    ...
    def _classify_regime(self, features: Dict[str, float]) -> str:
        ...
        if trend_strength > self.regime_detection_config["trend_threshold"]:
            ...
            return "candle"
        elif trend_strength < 0.1:  # Very low trend strength
            return "sr"
        else:
            return "sideways"
...
class RegimeSpecificOptimizer:
    ...
    def _regime_objective(self, trial: optuna.trial.Trial, 
    ...
    def _evaluate_regime_parameters(self, params: Dict[str, Any], 
                                  market_data: pd.DataFrame) -> float:
