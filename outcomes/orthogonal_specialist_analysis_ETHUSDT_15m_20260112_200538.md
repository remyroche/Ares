...
**Analysis Date:** 2026-01-12 20:05:38
**Weighting Metric:** auc
## Executive Summary
### Key Findings:
- **Baseline Ensemble AUC:** 0.9998
- **Orthogonal Ensemble AUC:** 0.9856
...
|-----------|-----|-------|-------------|
| volatility | 0.9707 | 0.500 | 0.485 |
| microstructure | 0.8776 | 0.248 | 0.218 |
| liquidity | 0.7955 | 0.210 | 0.167 |
| volume | 0.5000 | 0.127 | 0.063 |
| spectral | 0.5000 | 0.123 | 0.061 |
| xgb_macro | 0.5000 | 0.120 | 0.060 |
| smc | 0.5000 | 0.041 | 0.021 |

**Weight Concentration:** 36.5% (largest specialist weight)
**Total Weighted Contribution:** 1.076
**Weight Diversity (HHI):** 0.215 (Low concentration)
## Baseline vs Orthogonal Performance Comparison
### Performance Comparison:
| Approach | AUC | Features | Improvement |
|----------|-----|---------|------------|
| Baseline | 0.9998 | 19 | - |
| Orthogonal Ensemble | 0.9856 | - | -1.4% |
...
**Diversification Bonus:** -1.4%
#### Specialist Correlation Analysis:
- **Average Specialist Correlation:** nan
...
- **Total Features:** 19
- **Average Features per Specialist:** 2.7
- **Max Features:** 6
- **Min Features:** 1
