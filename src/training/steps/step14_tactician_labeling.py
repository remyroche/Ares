...
class TacticianTripleBarrierLabeler:
    ...
    - Higher confidence for reaching target prices - Price direction predictions - Market regime detection - Volatility and momentum predictions
    ...
    - Higher confidence scores - Multi - outcome prediction structure
    """
