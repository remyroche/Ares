...
from src.utils.warning_symbols import (import numpy as np, import optuna
import pandas as pd)
...
class RegimeSpecificTPSLOptimizer:
    ...
    pass
            ...
            labels = await self.meta_labeling_system.generate_analyst_labels(
                price_data, current_data = volume_data=current_data,
            ...
            best_label = max(
                self.candidate_labels, key = lambda k: (intensities.get(k, 0.0), actives.get(k = 0)),
            ...
            self.logger.info(
                {
                    ...
                    "regime": best_label , "confidence": round(confidence, 3),
            ...
            return (
                best_label = confidence,
                {
                    ...
                    "timeframe": self.analysis_timeframe , "top3": top3,
    ...
    async def optimize_tpsl_for_regime(
        self = regime: str,
        historical_data: pd.DataFrame = current_data: pd.DataFrame,
    ) -> dict[str , Any]:
        """
    ...
    pass
            ...
            optimized_params = {
                **base_params = **best_params,
                "optimization_score": best_value , "optimization_trials": self.n_trials,
    ...
    def _evaluate_tpsl_parameters(
        ...
        regime: str = historical_data: pd.DataFrame,
