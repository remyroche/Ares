...
This module extends the existing Optuna configuration to include regime-specific triple
barrier thresholds and TPSL parameters optimization. It provides a comprehensive
...
class RegimeSpecificOptimizationConfig:
    ...
    ) -> Optional[RegimeSpecificConstraints]:
...
def get_regime_optimization_config_for_regime(
    regime_name: str, base_config: Optional[RegimeSpecificOptimizationConfig] = None
) -> Dict[str, Any]:
