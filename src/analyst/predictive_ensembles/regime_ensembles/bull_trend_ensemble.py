    ...
    def _get_meta_features(
        ...
        **kwargs,
        ...
        if is_live:
            ...
            if meta_label_cols:
                self.logger.info(
                    f"BullTrendEnsemble meta-learner live features include meta-labels: {meta_label_cols}"
                )
            return base_preds
        meta_df = base_preds
        for col in raw_features_to_include:
        ...
        if meta_label_cols:
            ...
            self.logger.info(
                f"BullTrendEnsemble meta-learner train features include meta-labels: {meta_label_cols}"
            )
