...
def main():
    ...
    print("✅ Enhanced validation tools created:")
    print("  - enhanced_validation_wrapper.py: Enhanced validation function")
    print("  - feature_analysis_script.py: Analysis script for detailed reports")
    print("\\n📋 NEXT STEPS:")
    print("1. Modify step1_7_hmm_regime_discovery.py to use enhanced validation")
    print("2. Run the training pipeline to generate detailed reports")
    print("3. Use feature_analysis_script.py to analyze the reports")
