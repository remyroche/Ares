"""
Unified Exchange OHLCV Data Standardizer

This module provides a single, comprehensive standardization system that ensures
...
class UnifiedExchangeStandardizer:
    ...
    def __init__(self, quality_level: DataQualityLevel = DataQualityLevel.STANDARD):
        ...
        self.logger = system_logger.getChild("UnifiedExchangeStandardizer")
        ...
        self.logger.info(f"✅ UnifiedExchangeStandardizer initialized with {quality_level.value} quality level")
    ...
    def get_exchange_schema(self, exchange: ExchangeType) -> Dict[str, Any]:
        ...
        return {
            ...
            'interval_mapping': config.get('interval_mapping', {}),
            'supported_intervals': ['1m', '3m', '5m', '15m', '30m', '1h', '2h', '4h', '6h', '8h', '12h', '1d', '3d', '1w', '1M']
        }


# Global instance for easy access
unified_exchange_standardizer = UnifiedExchangeStandardizer()
