...
def fix_cluster_quality_assessor():
    ...
    old_pattern = r"(\s+params\.get\('K', 'N/A'\),\s+params\.get\('base_alpha', 'N/A'\),\s+params\.get\('kappa', 'N/A'\),\s+params\.get\('n_mixtures', 'N/A'\),)"
    ...
    old_svi_pattern = r"(\s+params\.get\('learning_rate', 'N/A'\),\s+params\.get\('svi_iterations', 'N/A'\),\s+trial\.get\('final_elbo', 'N/A'\),)"
