...
async def test_tactician_dual_training():
    ...
    print(f"   - Long base models: {len(training_result.long_base_models) if training_result.long_base_models else 0}")
    print(f"   - Short base models: {len(training_result.short_base_models) if training_result.short_base_models else 0}")
    print(f"   - Long ensemble models: {len(training_result.long_ensemble_models) if training_result.long_ensemble_models else 0}")
    print(f"   - Short ensemble models: {len(training_result.short_ensemble_models) if training_result.short_ensemble_models else 0}")
