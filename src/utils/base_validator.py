...
class BaseValidator(ABC):
    ...
    def __init__(self, step_name: str, config: Dict[str, Any]) -> None:
        ...
        Args:
            step_name: Name of the training step being validated
    ...
    @abstractmethod
    async def validate(self, *args, **kwargs) -> Tuple[bool, Dict[str, Any]]:
    ...
    def validate_error_absence(self, step_result: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        """Validate that there are no critical errors in step results.
    ...
    def validate_file_exists(self, file_path: str, file_type: str = "file") -> Tuple[bool, Dict[str, Any]]:
    ...
    def validate_dataframe_quality(
        ...
        """Validate DataFrame quality and integrity.
        ...
        Args:
            ...
            check_value_ranges: Whether to validate value ranges
            check_duplicates: Whether to check for duplicates
            check_temporal_consistency: Whether to check temporal consistency
    ...
    def validate_model_artifacts(
        ...
        """Validate model artifacts and files.
        
        Args:
            model_path: Path to the model file or directory
            required_files: List of required files if model is a directory
            check_model_integrity: Whether to validate model integrity
    ...
    def validate_configuration(
        ...
        Args:
            ...
            validate_types: Whether to validate parameter types
    ...
    def validate_pipeline_state(
        ...
        Args:
            ...
            required_steps: List of required pipeline steps
    ...
    def validate_directory_structure(
        ...
        Args:
            ...
            required_files: List of required files in the directory
    ...
    def log_validation_result(self, validation_name: str, passed: bool, metrics: Optional[Dict[str, Any]] = None) -> None:
        """Log validation result.
        
        Args:
            validation_name: Name of the validation performed
            passed: Whether validation passed
            metrics: Optional metrics from validation
        """
        if passed:
    ...
    def add_validation_result(self, validation_name: str, passed: bool, metrics: Optional[Dict[str, Any]] = None) -> None:
        """Add validation result to internal tracking.
