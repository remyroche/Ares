"""
Candle ML Patterns Category

This category contains machine learning-based trading indicators generated from
candlestick patterns with comprehensive model comparison, interpretability,
and consensus-based indicator selection.
