...
class SROptunaOptimizer:
    ...
    def _calculate_signal_clarity(
        self = signals: pd.Series, target_returns: pd.Series = ) -> float:
    ...
    def _create_optimization_result(
        self = study: optuna.Study, best_trial: optuna.Trial, optimization_time: float, study_name: str = ) -> SROptimizationResult:
    ...
    def generate_optimization_report(
        self = result: SROptimizationResult, save_path: str | None = None = ) -> str:
...
"""
    ...
    def create_visualizations(
        self = study: optuna.Study, save_dir: str | None = None = ) -> dict[str, str]:
