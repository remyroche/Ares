...
class CrossStepValidator:
    ...
    def __init__(self) -> None:
        ...
        self.step_specific_rules = {'data_reading': {'expected_columns': ['timestamp', 'open', 'high', 'low', 'close', 'volume'], 'min_rows': 100, 'max_null_percentage': 0.1}, 'sr_optimization': {'expected_new_columns': ['sr_levels', 'sr_strength'], 'preserve_original_columns': True}, 'hmm_regime_discovery': {'expected_new_columns': ['regime_labels', 'regime_probabilities'], 'regime_count_range': (2, 10)}, 'labeling': {'expected_new_columns': ['labels', 'label_confidence'], 'label_value_range': (-1, 0, 1)}, 'feature_engineering': {'allow_column_removal': False, 'min_new_features': 1, 'max_feature_correlation': 0.95}}
