...
try:
    ...
    # Fast fail: numpy is required for accelerator functionality
    raise ImportError(
        "numpy is required for accelerator functionality. "
...
try:
    ...
    # Fast fail: pandas is required for DataFrame operations
    raise ImportError(
        "pandas is required for accelerator DataFrame operations. "
...
try:
    ...
    # Fast fail: psutil is required for accelerator functionality
    raise ImportError(
        "psutil is required for accelerator functionality. "
