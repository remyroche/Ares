...
@handle_errors(
    exceptions=(ValueError, TypeError, KeyError, OSError), default_return=False
)
async def run_validator(
    ...
    try:
            ...
            if artifact_path.exists():
                ...
                # Validate JSON metadata
                    ...
                    try:
                        ...
                        missing_artifacts.append(
                            f"{artifact} - failed to read JSON: {e!s}"
                        )
            else:
        ...
        artifact_coverage = (
            artifacts_found / total_artifacts if total_artifacts > 0 else 0.0
        )
