...
class BasePipelineStep(IPipelineStep):
    ...
    def __init__(self, config: StepConfig, logger=None):
        self.config = config
        self.logger = logger
...
class StepFactory:
    ...
    _step_registry: Dict[str, type[IPipelineStep]] = {
        'data_loader': SimpleDataStep,
        'labeling': SimpleLabelingStep,
    }
    ...
    @classmethod
    def create_step(cls, config: StepConfig, logger=None) -> IPipelineStep:
