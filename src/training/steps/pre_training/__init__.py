...
from .regime_aware_feature_interaction_generation_step import RegimeAwareFeatureInteractionGenerationStep
...
step_registry.register('regime_aware_feature_interaction_generation_step', RegimeAwareFeatureInteractionGenerationStep)
