...
class StandardizedErrorHandler:
    ...
    def get_recovery_strategy(
        self, error_type: Union[Exception, ErrorCategory]
    ) -> Dict[str, Any]:
    ...
    def log_error_with_context(
        ...
        """
        context = {"data_context": data_context or {}, "operation": "unknown"}
...
"""
    ...
    def get_error_summary(self, step_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        summary["recent_errors"] = [error.to_dict() for error in filtered_errors[-10:]]
