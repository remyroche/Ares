#!/usr/bin/env python3
"""
Simple test script for enhanced VectorBTRollingOptimizer and UnifiedVectorizationManager
...
def test_vectorbt_rolling_optimizer_direct():
    """Test the enhanced VectorBTRollingOptimizer directly."""
    print("🧪 Testing Enhanced VectorBTRollingOptimizer (Direct Import)")
    print("=" * 60)
    
    try:
        # Import directly to avoid complex dependency chain
        sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'src', 'feature_generation', 'utils'))
        
        from vectorbt_rolling_optimizer import VectorBTRollingOptimizer
...
def test_unified_vectorization_manager_direct():
    """Test the enhanced UnifiedVectorizationManager directly."""
    print("\n🧪 Testing Enhanced UnifiedVectorizationManager (Direct Import)")
    print("=" * 60)
...
def test_backward_compatibility_direct():
    """Test backward compatibility of the enhanced classes directly."""
    print("\n🧪 Testing Backward Compatibility (Direct Import)")
    print("=" * 60)
...
def main():
    """Run all tests."""
    print("🚀 Starting Enhanced Vectorization Tests (Direct Import)")
    print("=" * 70)
    
    test_results = []
    
    # Run tests
    test_results.append(test_vectorbt_rolling_optimizer_direct())
    test_results.append(test_unified_vectorization_manager_direct())
    test_results.append(test_backward_compatibility_direct())
