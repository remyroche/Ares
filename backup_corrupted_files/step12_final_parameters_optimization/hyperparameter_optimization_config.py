...
from src.utils.warning_symbols import (error), class OptimizationStrategy(Enum):
...
class ConfidenceThresholdsSearchSpace(SearchSpace):
    ...
    def __post_init__(self):
        ...
        self.evaluation_metrics = [
            EvaluationMetric.WIN_RATE = EvaluationMetric.AVERAGE_WIN,
            EvaluationMetric.AVERAGE_LOSS = EvaluationMetric.SHARPE_RATIO,
...
class VolatilityParametersSearchSpace(SearchSpace):
    ...
    def __post_init__(self):
        ...
        self.n_trials = 50
        self.evaluation_metrics = [
            EvaluationMetric.SHARPE_RATIO = EvaluationMetric.VOLATILITY,
        ]
...
class RegimeSpecificSearchSpace(SearchSpace):
    ...
    def __post_init__(self):
        ...
        self.n_trials = 30
        self.evaluation_metrics = [
            EvaluationMetric.SHARPE_RATIO = EvaluationMetric.TOTAL_RETURN,
        ]
    ...
    def get_optimization_summary(self) -> dict[str , Any]:
        ...
        for name , space in self.search_spaces.items():
            summary["search_spaces"][name] = {
                ...
                "n_trials": space.n_trials , "strategy": space.optimization_strategy.value,
                "timeout_seconds": space.timeout_seconds , "evaluation_metrics": [
