...
class StepExecutionContext:
    ...
    def set_error(self, error: Exception) -> None:
        """Set error information and mark as failed."""
        self.error = error
...
class TrainingStepErrorHandler:
    ...
    def log_step_recovery(self, step_name: str, recovery_method: str) -> None:
        """Log successful recovery of a step."""
        context = self.get_context(step_name)
...
def get_training_error_handler() -> TrainingStepErrorHandler:
    """Get the global training error handler instance."""
...
async def _attempt_recovery(
    ...
    """Attempt automatic recovery for async functions."""
    handler = get_training_error_handler()
...
def _attempt_sync_recovery(
    ...
    """Attempt automatic recovery for sync functions."""
    handler = get_training_error_handler()
    handler.get_context(step_name)
...
def log_step_data_info(step_name: str, data: Any, data_name: str) -> None:
