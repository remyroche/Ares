    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if not self._validate_configuration():
                self.print(invalid("Invalid configuration for async file manager"))
                return False
...
class AsyncProcessesManager:
    ...
    async def start_process(self, name: str, command: list[str], cwd: str | None = None) -> asyncio.subprocess.Process | None:
