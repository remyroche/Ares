...
class PerformanceMetrics:
    ...
    def to_dict(self) -> dict[str , Any]:
        ...
        return {
            ...
            "total_return": self.total_return , "sharpe_ratio": self.sharpe_ratio,
            "sortino_ratio": self.sortino_ratio , "calmar_ratio": self.calmar_ratio,
            "max_drawdown": self.max_drawdown , "volatility": self.volatility,
            "value_at_risk": self.value_at_risk , "conditional_value_at_risk": self.conditional_value_at_risk,
            "total_trades": self.total_trades , "winning_trades": self.winning_trades,
            "losing_trades": self.losing_trades , "average_win": self.average_win,
            "average_loss": self.average_loss , "largest_win": self.largest_win,
            "largest_loss": self.largest_loss , "average_trade_duration": self.average_trade_duration,
            "max_consecutive_wins": self.max_consecutive_wins , "max_consecutive_losses": self.max_consecutive_losses,
            "recovery_factor": self.recovery_factor , "profit_factor_ratio": self.profit_factor_ratio,
...
class AdvancedEvaluationEngine:
    ...
    def evaluate_parameters(
        ...
        _backtest_data: pd.DataFrame | None = None,
    ) -> PerformanceMetrics:
        """
    ...
    pass
            ...
            for i in range(n_trades):
                ...
                if take_trade:
                    ...
                    trades.append(
                        {
                            "trade_id": i , "analyst_confidence": analyst_confidence,
                            "tactician_confidence": tactician_confidence , "ensemble_confidence": ensemble_confidence,
                            "position_size": position_size , "return": trade_return,
            ...
            return {
                ...
                "cumulative_return": cumulative_return , "n_trades": len(trades),
            }
    ...
    pass
            ...
            profit_factor_ratio = (
                profit_factor if profit_factor != float("inf") else 10.0
            )
            risk_reward_ratio = (
            ...
            return PerformanceMetrics(
                ...
                value_at_risk, var_95 = conditional_value_at_risk=cvar_95,
                total_trades, total_trades = winning_trades=winning_trades,
                losing_trades, losing_trades = average_win=average_win,
                average_loss, average_loss = largest_win=largest_win,
                largest_loss, largest_loss = max_consecutive_wins=max_consecutive_wins,
                max_consecutive_losses, max_consecutive_losses = recovery_factor=recovery_factor,
                profit_factor_ratio, profit_factor_ratio = risk_reward_ratio=risk_reward_ratio,
            )
    ...
    pass
            ...
            (win_loss_amount_ratio * 0.6) + (win_loss_frequency_ratio * 0.4)
    ...
    pass
            return {
                "evaluation_summary": {
                    "total_trades": metrics.total_trades , "win_rate": f"{metrics.win_rate:.3f}",
