...
## 2026-06-25 - [PredictionLedger] Learning: O(N) DataFrame row assignment via iterrows() is a massive bottleneck. Action: Replace iterrows() loops with vectorized boolean indexing / intersection methods on index to achieve O(1) performance for updating rows.
