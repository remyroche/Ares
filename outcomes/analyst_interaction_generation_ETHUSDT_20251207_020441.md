...
- **Total Features**: 200
- **Base Features**: 113
- **Interaction Features**: 87
- **Feature Density**: 18.2 features per category
- **Interaction Ratio**: 43.5%

## Category Coverage Analysis
- 🟢 **Trend**: 134 features (Excellent)
- 🟡 **Oscillator**: 6 features (Good)
- 🟡 **Momentum**: 7 features (Good)
- 🟢 **Returns**: 14 features (Excellent)
- 🟢 **Volatility**: 19 features (Excellent)
- 🟡 **Volume**: 7 features (Good)
- 🔴 **Acceleration**: 0 features (Poor)
- 🟠 **Entropy**: 3 features (Adequate)
- 🔴 **Spectral_Wavelet**: 1 features (Poor)
- 🔴 **Support_Resistance**: 0 features (Poor)
- 🟡 **Unknown**: 9 features (Good)
...
*Generated on 2025-12-07 02:04:41*
