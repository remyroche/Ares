...
class MultiObjectiveHMMOptimizer:
    ...
    def optimize(self,
        ...
        print("🚀 Starting Multi-Objective HMM Optimization...")
    ...
    def _calculate_transition_smoothness(self, cluster_data: pd.DataFrame) -> float:
        ...
        smoothness = 1.0 - entropy / max_entropy if max_entropy > 0 else 0.0
    ...
    def _dominates(self, individual1: Individual, individual2: Individual) -> bool:
        ...
        at_least_as_good = all(obj1 >= obj2 for obj1, obj2 in zip(objectives1, objectives2, strict=False))

        # Check if individual1 is strictly better in at least one objective
        strictly_better=any(obj1 > obj2 for obj1, obj2 in zip(objectives1, objectives2, strict=False))
