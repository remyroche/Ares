...
"""
        metadata = EventMetadata()""""
            ...
            version=metadata_dict.get("version", "1.0_0"),""""
            schema_version=metadata_dict.get("schema_version", "1.0_0"),"""
            timestamp=timestamp,""""
...
"""
            ...
            if current_version == "1.0_0" and target_version == "1.1_0":""""
