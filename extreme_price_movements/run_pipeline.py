...
from extreme_price_movements.pipeline_steps import run_label_generation_step_v2, run_feature_generation_step, run_training_step, run_backtest_step
...
def main():
    ...
    parser.add_argument("mode", choices=["labels", "features", "train", "backtest"],
