...
from src.utils.common_operations import ensure_directory, safe_json_load
from src.utils.warning_symbols import error, failed, invalid, missing, validation_error
    ...
    def _validate_final_model_files(
        ...
        try:
            ...
            for file_path in expected_files:
                ...
                self.validation_results.setdefault("final_model_files", {}).update(
                    file_metrics
                )
                if not file_passed:
