...
import class TimeframeRelevanceAnalyzer:
class TimeframeRelevanceAnalyzer:
    ...
    pass
        ...
        self.leverage_config = config.get("high_leverage_trading", {
            "min_leverage": 10,
            "max_leverage": 100,
            "target_leverage": 25,
        ...
        self.analysis_config = config.get("timeframe_analysis", {
    ...
    pass
            ...
            analysis["volatility_metrics"] = {
                ...
                "volatility_regime_stability": self._calculate_volatility_stability(returns)
            }
    ...
    pass
                ...
                volatility_data[timeframe] = {
                    ...
                    "vol_regime_changes": self._count_volatility_regime_changes(returns)
                }
    ...
    pass
        ...
        return {
            ...
            "volatility_regime_analysis": self._analyze_volatility_regimes(volatility_data)
        }
    ...
    pass
        ...
        return {
            ...
            "optimal_signal_horizon": self._calculate_optimal_signal_horizon(signal_quality)
        }
    ...
    pass
            ...
            signal_quality = signal_analysis.get("timeframe_signal_quality", {}).get(
                timeframe, {}
    ...
    pass
            recommendations["ensemble_recommendations"] = {
                ...
                "secondary_timeframes": [tf for tf, w in weights.items() if 0.1 <= w <= 0.2],
                "excluded_timeframes": [tf for tf in timeframe_analysis.keys() if tf not in weights],
        ...
        recommendations["risk_management_recommendations"] = {
            ...
            "stop_loss_recommendations": self._calculate_stop_loss_recommendations(analysis_results)
        }
    ...
    pass
        ...
        direction = np.sign(returns)
        consistency = direction.rolling(10).apply(
