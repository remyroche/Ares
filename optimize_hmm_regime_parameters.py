...
class HMMRegimeOptimizer:
    ...
    def _apply_regime_merging(self, initial_cluster_data: pd.DataFrame,
        ...
        merging_params.get("target_regimes", 18)
    ...
    def _calculate_regime_characteristics(self, cluster_data: pd.DataFrame,
        ...
        return regime_stats.rename(columns={"composite_cluster_id": "regime_id"})
    ...
    def _hierarchical_regime_merging(self, cluster_data: pd.DataFrame,
        ...
        regime_mapping=dict(zip(regime_characteristics["regime_id"], regime_clusters, strict=False))
        return cluster_data["composite_cluster_id"].map(regime_mapping).values
    ...
    def _calculate_cluster_quality_score(self, cluster_data: pd.DataFrame) -> float:
        ...
        try:
            ...
            # Combine scores
            return (silhouette + davies_normalized) / 2.0
    ...
    def _calculate_market_separation_score(self, cluster_data: pd.DataFrame,
        ...
        for col in market_condition_columns:
            ...
            ((cluster_data[col] - overall_mean) ** 2).sum()
    ...
    def optimize(self, data: pd.DataFrame,
        ...
        print("🚀 Starting HMM regime parameter optimization...")
    ...
    def generate_optimization_report(self, output_path: str | None = None) -> str:
        ...
        report.append("")
        report.append("🎯 **Objective**: Optimize HMM regime discovery parameters to achieve 15-20 distinct, internally coherent regimes")
        ...
        if regime_counts:
            ...
            report.append("- **Target Range**: 15-20 regimes")
    ...
    def create_optimization_visualizations(self, output_dir: str | None = None) -> None:
