...
class Step6HMMBasedEnhancementValidator(BaseValidator):
    ...
    async def validate(
        ...
        try: error_passed = error_metrics = self.validate_error_absence(step_result)
        ...
        try: model_files_passed = self._validate_enhanced_model_files(
                symbol,
                exchange,
                data_dir,
            )
        ...
        try: improvement_passed = self._validate_performance_improvement(
                symbol,
                exchange,
                data_dir,
            )
        ...
        try: quality_passed = self._validate_enhancement_quality(
        ...
        try: outcome_passed = outcome_metrics, self.validate_outcome_favorability(
                step_result,
            )
