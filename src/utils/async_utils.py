...
class AsyncFileManager:
    ...
    @staticmethod
    @handle_file_operations(default_return="", context="async_read_file")
    ...
    @staticmethod
    @handle_file_operations(default_return=False, context="async_write_file")
    ...
    @staticmethod
    @handle_file_operations(default_return=False, context="async_append_file")
    ...
    @staticmethod
    @handle_file_operations(default_return=b"", context="async_read_binary")
    ...
    @staticmethod
    @handle_file_operations(default_return=False, context="async_write_binary")
    ...
    @staticmethod
    @handle_file_operations(default_return="", context="async_read_json")
    ...
    @staticmethod
    @handle_file_operations(default_return=False, context="async_write_json")
    ...
    @staticmethod
    @handle_file_operations(default_return="", context="async_calculate_checksum")
...
class AsyncProcessManager:
    ...
    @staticmethod
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="async_run_process"
    )
    ...
    @staticmethod
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="async_run_python_script"
    )
    async def run_python_script(
        script_path: str, args: List[str] = None, timeout: int = 30
    ) -> Optional[Dict[str, Any]]:
...
class AsyncNetworkManager:
    ...
    @staticmethod
    @handle_network_operations(
        max_retries=3, default_return=None, context="async_http_request"
    )
