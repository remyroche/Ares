...
while maintaining TAS-specific functionality and regime analysis.
"""
...
class BacktestingEngine:
    """
    TAS-specific backtesting engine wrapper.
    
    This class wraps the unified backtesting engine from src/utils/nas_tas/
    while maintaining TAS-specific functionality for regime analysis.
    """
    
    def __init__(self, config: BacktestingConfig):
        """Initialize TAS backtesting engine.
        
        Args:
            config: TAS backtesting configuration
        """
        self.config = config
        ...
        self.logger.info("✅ TAS Backtesting Engine initialized with unified engine")
    ...
    async def run_backtest(self, 
        ...
        """
        self.logger.info("🚀 Starting TAS backtesting analysis with unified engine")
        ...
        try:
            ...
            self.results = result
            self.logger.info(f"✅ TAS Backtesting completed in {result.execution_time:.2f}s")
