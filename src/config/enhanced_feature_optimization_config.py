...
optimizes the optimization process itself using RF, SHAP, MI, and multi-objective
optimization.
"""
...
def get_parameter_importance_weights() -> dict[str, float]:
    ...
    return {
        ...
        "MACD": {"fast_period": 0.7, "slow_period": 0.7, "signal_period": 0.5},
        "Bollinger_Bands": {
            "lookback_period": 0.8,
            "std_dev": 0.6,
            "squeeze_threshold": 0.5,
        },
        "SMA": {"short_period": 0.7, "long_period": 0.7},
        "EMA": {"short_period": 0.7, "long_period": 0.7},
        "ATR": {"lookback_period": 0.8},
        "Stochastic": {
            "k_period": 0.7,
            "d_period": 0.5,
            "overbought": 0.4,
        ...
        "ADX": {"lookback_period": 0.8, "threshold": 0.5},
        "CCI": {"lookback_period": 0.8, "constant": 0.6},
    }
