...
from src.utils.database_security import DatabaseType, database_security_manager
from src.utils.logger import system_logger
from src.utils.security_framework import SecurityLevel, security_framework
...
class ComprehensiveSecurityTester:
    ...
    def test_database_security(self) -> bool:
        ...
        try:
            ...
            self.logger.exception(f"Database security test failed: {e}")
            return False
    ...
    def _calculate_security_score(self) -> float:
        ...
        return min(1.0, base_score + encryption_score + audit_score + ssl_score)
