...
class HMMCompositeManager:
    ...
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="HMM block states loading"
    )
    ...
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="HMM meta loading"
    )
    def load_meta(
        self,
        exchange: str,
    ...
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="HMM intensity loading"
    )
    def load_intensity(
        self,
        exchange: str,
    ...
    @handle_errors(
        exceptions=(Exception,), default_return=None, context="HMM basic meta loading"
    )
    def load_basic_meta(
        self,
        exchange: str,
    ...
    async def create_composite_clusters(
        ...
        try:
            ...
            self.logger.error(f"❌ Error creating HMM composite clusters: {e}")
            return False
    ...
    async def get_or_create_composite_clusters(
        ...
        success = await self.create_composite_clusters(
            exchange, symbol, timeframe, data_dir, force_rerun, lookback_days
        )
    ...
    def clear_cache(
        self, exchange: str = None, symbol: str = None, timeframe: str = None
    ):
        """
