...
@handle_errors( exceptions=(FileNotFoundError, yaml.YAMLError, ValueError), default_return={}, context="YAML config loading", )
...
@handle_errors( exceptions=(FileNotFoundError, yaml.YAMLError, ValueError), default_return={}, context="position sizing config loading", )
...
@handle_errors( exceptions=(FileNotFoundError, yaml.YAMLError, ValueError), default_return={}, context="leverage sizing config loading", )
...
@handle_errors( exceptions=(FileNotFoundError, yaml.YAMLError, ValueError), default_return={}, context="combined sizing config loading", )
...
@handle_errors( exceptions=(FileNotFoundError, yaml.YAMLError, ValueError), default_return={}, context="config validation", )
...
@handle_errors( exceptions=(Exception,), default_return={}, context="config merging", )
...
@handle_errors( exceptions=(Exception,), default_return={}, context="config loading with fallback", )
