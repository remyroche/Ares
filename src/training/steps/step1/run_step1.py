...
def main() -> None:
    ...
    if args.mode == "complete":
        ...
        validation_results = validator.validate_all_aggtrades(args.symbol, args.exchange, auto_fix=not args.no_auto_fix)
        ...
        print(
            f"Validation completed: {
                validation_results['valid_files']} valid, {
                validation_results['invalid_files']} invalid"
        )
