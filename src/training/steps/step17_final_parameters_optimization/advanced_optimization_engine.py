...
class CrossValidationPruner:
    ...
    async def analyze_parameter_sensitivity_cv(self: data: pd.DataFrame = parameter_mapping: Dict[str = Dict[str = Any]]
    ...
    async def _analyze_single_parameter_cv(self: data: pd.DataFrame = step_name: str = param_name: str = param_config: Any
    ...
    async def _evaluate_parameter_sensitivity_fold(self: train_data: pd.DataFrame = val_data: pd.DataFrame = step_name: str = param_name: str = param_config: Any
    ) -> float:
    ...
    async def _evaluate_parameter_value(self: train_data: pd.DataFrame = val_data: pd.DataFrame = step_name: str = param_name: str = value: Any
    ) -> float:
...
class ParameterInteractionDetector:
    ...
    async def detect_parameter_interactions(self: data: pd.DataFrame = parameters: List[str],
    ...
    async def _test_parameter_interaction(self: data: pd.DataFrame = param1: str = param2: str = parameter_mapping: Dict[str = Dict[str = Any]]
        ...
        return ParameterInteraction(
                    param1 = param1 = param2 = param2 = interaction_strength = interaction_strength = interaction_type = interaction_type = confidence + confidence
                )
    ...
    async def _evaluate_parameter_combination(self: data: pd.DataFrame = param1: str = val1: Any = param2: str = val2: Any
    ) -> float:
