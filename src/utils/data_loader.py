...
from .centralized_decorators import guard_dataframe_nulls, with_tracing_span
...
class PartitionedDataLoader:
    ...
    def __init__(self, logger=None, cache_size=100):
        """Initialize the PartitionedDataLoader.
        
        Args:
            logger: Logger instance to use
            cache_size: Maximum number of cached partitions
        """
    ...
    def load_partitioned_data(
        ...
        **kwargs
        ...
        """Load data from partitioned dataset.
        
        Args:
            base_dir: Base directory containing partitioned data
            exchange: Exchange name
            symbol: Symbol name
            data_type: Type of data (e.g., 'ohlcv', 'trades')
            ...
            enable_partition_pruning: Whether to enable partition pruning
    ...
    def _load_with_pyarrow_streaming(
        ...
        **kwargs
        ...
        """Load data using PyArrow streaming for memory efficiency."""
        # Create dataset
    ...
    def _load_with_pyarrow(
        ...
        **kwargs
        ...
        """Load data using PyArrow for better performance."""
        # Create dataset
        dataset = ds.dataset(dataset_path, format="parquet")
    ...
    def _load_with_pandas(
        ...
        **kwargs
        ...
        """Load data using pandas as fallback."""
    ...
    def _build_filter_expression(
        ...
        """Build PyArrow filter expression from filter tuples."""
    ...
    def get_available_partitions(
        self, base_dir: str, exchange: str, symbol: str, data_type: str
    ) -> List[str]:
    ...
    def _optimize_filters_for_pruning(
        self, filters: List[Tuple[str, str, Any]], dataset_path: str
    ...
    def _get_partition_info(self, dataset_path: str) -> Dict[str, Any]:
        """Get partition information from dataset."""
        if PYARROW_AVAILABLE:
            try:
    ...
    def optimize_partition_access(
        ...
        """Get recommendations for optimizing partition access."""
...
def load_partitioned_data(
    ...
    **kwargs
    ...
    """Convenience function for loading partitioned data."""
    ...
    return loader.load_partitioned_data(
        ...
        use_streaming=use_streaming, **kwargs
    )
