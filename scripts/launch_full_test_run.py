...
def main():
    ...
    parser.add_argument("exchange", nargs="?", default="BINANCE", help="Exchange name (default: BINANCE)")
    ...
    print(f"🚀 Launching full test run for {args.symbol} on {args.exchange} with GUI...")
