...
> **Superseded history boundary — 2026-08-12.** The original study below used
> a ledger beginning in January 2025 and therefore could not fit a complete
> nine-month A0/A4 history until October 2025. The canonical regeneration now
> includes April--December 2024 as training/calibration warm-up. Its first
> January 2025 producer therefore has the complete declared nine-calendar-month
> input window. The authoritative regenerated artifact is
> `data_perp/artifacts/strict_r3_canonical_a5_long_2025_jul2026_2024warmup_20260812_v1`.
> All 21 January-2025--July-2026 folds fit, and none failed closed for missing
> history. Metrics below that explicitly refer to the old October-2025-only
> population remain valid for that narrower study, but no longer define the
> canonical executable-history boundary.

The canonical January-2025 through July-2026 replay is causal relative to each
held producer cutoff and uses one frozen October--December-2024 geometry/K9
bundle. The first January 2025 A0/A4 fit uses April--December 2024, selects
60,000 equal-month rows from that complete nine-month history, and evaluates
only January 2025 and later rows.
