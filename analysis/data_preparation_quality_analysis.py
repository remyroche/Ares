...
try:
    ...
    def problem(msg): print(f"PROBLEM: {msg}")
    def failed(msg): print(f"FAILED: {msg}")
    def invalid(msg): print(f"INVALID: {msg}")
    def missing(msg): print(f"MISSING: {msg}")
    def timeout(msg): print(f"TIMEOUT: {msg}")
    def connection_error(msg): print(f"CONNECTION_ERROR: {msg}")
    def validation_error(msg): print(f"VALIDATION_ERROR: {msg}")
    def initialization_error(msg): print(f"INITIALIZATION_ERROR: {msg}")
    def execution_error(msg): print(f"EXECUTION_ERROR: {msg}")
...
class DataPreparationQualityAnalyzer:
    """Data Preparation Quality Analyzer"""
