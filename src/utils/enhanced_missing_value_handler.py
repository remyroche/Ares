...
class GapType(Enum):
    """Enumeration for different types of data gaps."""
...
class EnhancedMissingValueHandler:
    ...
    def __init__(self, max_forward_fill_gap: int = 5, download_threshold: int = 60):
    ...
    def handle_missing_values_intelligently(
        ...
        """Intelligently handle missing values in time series data.
    ...
    def _analyze_gaps(self, data: pd.DataFrame, timestamp_column: str) -> List[GapInfo]:
        """Analyze data for gaps in timestamps."""
        gaps = []
    ...
    def _handle_large_gap_with_download(
        ...
        """Handle large gaps by downloading missing data."""
    ...
    def _handle_large_gap_with_fallback(
        ...
        """Handle large gaps with interpolation fallback."""
    ...
    def _handle_critical_gap(
        ...
        """Handle critical gaps requiring manual intervention."""
    ...
    def get_gap_report(self, data: pd.DataFrame, timestamp_column: str) -> Dict[str, Any]:
        """Generate a comprehensive report of data gaps."""
        gaps = self._analyze_gaps(data, timestamp_column)
