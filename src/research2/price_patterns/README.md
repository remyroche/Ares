...
```python
from src.research.price_patterns import PurePricePatternOrchestrator
...
```python
from src.research.price_patterns import GradientPatternTargetGenerator
...
```python
from src.research.price_patterns import LSTMPricePatternDiscovery
...
```python
from src.research.price_patterns import MatrixProfileOrchestrator
