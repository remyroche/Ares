# Regime Clustering Exhaustive Detailed Report

**Generated**: 2025-10-26T23:25:27.645851  
**Symbol**: ETHUSDT  
**Exchange**: binance  
**Timeframe**: 1h  
...
- **Total Samples**: 1,920
- **Unique Clusters**: 6
- **Noise Points**: 92 (4.79%)
- **Valid Clusters**: 6

### Cluster Size Distribution
- **Mean Cluster Size**: 305 samples (15.87%)
- **Median Cluster Size**: 320 samples (16.67%)
- **Min Cluster Size**: 228 samples (11.88%)
- **Max Cluster Size**: 320 samples (16.67%)
- **Standard Deviation**: 34 samples (1.79%)
- **Coefficient of Variation**: 0.113

### Balance Metrics
- **Size Balance Score**: 0.887
- **Target Balance**: 15.9% (ideal: 12.5% for 8 clusters)
...
#### Basic Statistics
- **Size**: 228 samples (11.88%)
- **Rank**: #1 of 6 clusters
...
- **Shortest Segment**: 1 periods
- **Segment Length Std**: 0.0
- **Fragmentation Score**: 0.820

#### Stability Metrics
- **Stability Score**: 0.126
- **Stability Level**: Low
- **Cohesion Score**: 0.180
- **Boundary Clarity**: 0.181
- **Temporal Consistency**: 0.003
- **Isolation Score**: 0.237

#### Refinement Analysis
- **Original Size**: 1,224 samples
- **Size Change**: -996 samples (-81.37%)
- **Refinement Impact**: Reduced
- **Stability Change**: +0.000
...
#### Quality Assessment
- **Overall Quality**: Poor (0.122)
- **Recommendation**: Poor regime - needs refinement
...
#### Basic Statistics
- **Size**: 320 samples (16.67%)
- **Rank**: #2 of 6 clusters
- **Size Category**: Medium
- **Density**: High
...
#### Stability Metrics
- **Stability Score**: 0.469
- **Stability Level**: Medium
- **Cohesion Score**: 0.616
- **Boundary Clarity**: 0.618
- **Temporal Consistency**: 0.131
- **Isolation Score**: 0.333

#### Refinement Analysis
- **Original Size**: 259 samples
- **Size Change**: +61 samples (+23.55%)
...
#### Quality Assessment
- **Overall Quality**: Poor (0.370)
- **Recommendation**: Weak regime - avoid trading
...
#### Stability Metrics
- **Stability Score**: 0.401
- **Stability Level**: Medium
- **Cohesion Score**: 0.572
- **Boundary Clarity**: 0.574
- **Temporal Consistency**: 0.012
- **Isolation Score**: 0.333

#### Refinement Analysis
- **Original Size**: 63 samples
- **Size Change**: +257 samples (+407.94%)
- **Refinement Impact**: Improved
- **Stability Change**: +0.000
- **Quality Change**: +0.000
...
#### Stability Metrics
- **Stability Score**: 0.302
- **Stability Level**: Low
- **Cohesion Score**: 0.378
- **Boundary Clarity**: 0.379
- **Temporal Consistency**: 0.001
- **Isolation Score**: 0.333

#### Refinement Analysis
- **Original Size**: 0 samples
- **Size Change**: +320 samples (+0.00%)
- **Refinement Impact**: Improved
- **Stability Change**: +0.000
- **Quality Change**: +0.000
...
#### Stability Metrics
- **Stability Score**: 0.366
- **Stability Level**: Low
- **Cohesion Score**: 0.416
- **Boundary Clarity**: 0.417
- **Temporal Consistency**: 0.006
- **Isolation Score**: 0.333
...
#### Quality Assessment
- **Overall Quality**: Poor (0.261)
- **Recommendation**: Poor regime - needs refinement

---

### 🎯 Cluster 5 - Detailed Analysis

#### Basic Statistics
- **Size**: 320 samples (16.67%)
- **Rank**: #6 of 6 clusters
- **Size Category**: Medium
- **Density**: High
...
#### Stability Metrics
- **Stability Score**: 0.318
- **Stability Level**: Low
- **Cohesion Score**: 0.453
...
- **CV Ratio**: N/A (Higher = Better Regime Separation)
- **Within-Cluster CV**: N/A (Lower = More Cohesive Regimes)
- **Between-Cluster CV**: N/A (Higher = Better Separation)
- **Robust Feature CV**: N/A (Overall Feature Stability)

### Global Statistics
- **Average CV (Cluster Size Variation)**: 0.11253733803609443
- **Cluster Size Standard Deviation**: 34.286375654996775
- **Cluster Size CV**: 0.11253733803609443
- **Temporal Stability**: 0.4429390307451798

### Refinement Effectiveness
- **Refinement Success Rate**: N/A
- **Quality Improvement**: N/A
- **Balance Improvement**: N/A
...
- **Total Processing Time**: 16.41 seconds
- **Memory Usage**: N/A MB
- **CPU Usage**: N/A%
