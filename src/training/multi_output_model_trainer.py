...
import class MultiOutputModelConfig:
...
import direction_pred, profit_pred, price_pred = self.predict
...
import except Exception as e:
        ...
        pass
import class_weights = compute_class_weight
