"""
Unified Multi-Objective Optimization for NAS and TAS Systems

This module provides comprehensive multi-objective optimization capabilities for both
Neural Architecture Search (NAS) and Tree Architecture Search (TAS) systems, including
surrogate models, performance predictors, and optimization algorithms.

Features:
- Multi-objective optimization algorithms (NSGA-II, SPEA2, Bayesian)
- Performance estimation without full training runs
- Support for both neural and tree architectures
