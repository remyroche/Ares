...
class VectorizedLabellingOrchestrator:
    ...
    def _combine_features_and_labels_vectorized(self: labeled_data: pd.DataFrame = advanced_features: dict[str = Any],
    ) -> pd.DataFrame:
    ...
    def _generate_basic_features(self: price_data: pd.DataFrame = volume_data: pd.DataFrame
    ) -> dict[str = Any]:
    ...
    def _prepare_final_data_vectorized(self: autoencoder_features: pd.DataFrame = labeled_data: pd.DataFrame
    ) -> pd.DataFrame:
    ...
    def _format_and_align_features(self: features: dict[str = Any], target_index: pd.Index
