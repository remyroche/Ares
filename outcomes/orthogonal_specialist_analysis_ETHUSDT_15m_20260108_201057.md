...
**Analysis Date:** 2026-01-08 20:10:57
**Weighting Metric:** auc
## Executive Summary
### Key Findings:
- **Baseline Ensemble AUC:** 0.9996
- **Orthogonal Ensemble AUC:** 0.9362
- **Performance Improvement:** -6.3%
- **Specialists Analyzed:** 6
- **Best Specialist:** microstructure (AUC: 0.9057)
...
| microstructure | 0.9057 | 0.457 | 0.414 |
...
**Total Weighted Contribution:** 1.028
...
|----------|-----|---------|------------|
| Baseline | 0.9996 | 15 | - |
| Orthogonal Ensemble | 0.9362 | - | -6.3% |
...
**Diversification Bonus:** -6.3%
#### Specialist Correlation Analysis:
- **Average Specialist Correlation:** 0.403
