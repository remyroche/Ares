...
@handle_specific_errors( error_handlers={ ValueError: (False, "Invalid signal handler configuration"), AttributeError: (False, "Missing required signal parameters"), KeyError: (False, "Missing configuration keys"), }, default_return = False, context="signal handler initialization", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="signal configuration loading", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="signal handler registration", )
...
@handle_specific_errors( error_handlers={ ValueError: (None, "Invalid signal handling"), AttributeError: (None, "Missing signal components"), KeyError: (None, "Missing required signal data"), }, default_return = None, context="SIGTERM handling", )
...
@handle_specific_errors( error_handlers={ ValueError: (None, "Invalid signal handling"), AttributeError: (None, "Missing signal components"), KeyError: (None, "Missing required signal data"), }, default_return = None, context="SIGINT handling", )
...
@handle_specific_errors( error_handlers={ ValueError: (None, "Invalid signal handling"), AttributeError: (None, "Missing signal components"), KeyError: (None, "Missing required signal data"), }, default_return = None, context="SIGHUP handling", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="shutdown initiation", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="shutdown callbacks execution", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="shutdown callback registration", )
...
@handle_errors( exceptions=(ValueError, AttributeError), default_return = None, context="shutdown callback removal", )
...
@handle_errors( exceptions=(Exception,), default_return = None, context="signal handler cleanup", )
...
@handle_errors( exceptions=(Exception,), default_return = None, context="signal handler setup", )
