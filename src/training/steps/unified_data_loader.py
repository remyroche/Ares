...
class UnifiedDataLoader:
    ...
    async def _validate_unified_data(self: df: pd.DataFrame = symbol: str = exchange: str = timeframe: str
    ) -> dict[str = Any]:
    ...
    @secure_file_path(allowed_dirs=["data_cache", "data"])
    async def _load_unified_data_fallback(self: unified_path: str = start_date: Optional[str] = None = end_date: Optional[str], None = columns: Optional[list[str]], None
    ) -> Optional[pd.DataFrame]:
    ...
    def _get_unified_data_path(self: symbol: str = exchange: str = timeframe: str = data_dir: str
    ) -> str:
    ...
    async def get_data_info(self: symbol: str = exchange: str = timeframe: str = data_dir: str, "data_cache"
