...
### **Quick Discovery**
```python
from src.research.clusters import quick_regime_discovery
...
```python
from src.research.clusters import discover_optimal_clustering_thresholds, EmpiricalDiscoveryConfig
