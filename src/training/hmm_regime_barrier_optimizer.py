...
class HMMRegimeBarrierOptimizer:
    """HMM Regime Barrier Optimizer for automatic barrier recalculation and
    optimization.

    This class provides the interface needed by the vectorized labeling orchestrator to
    automatically recalculate HMM regime barriers and apply regime-aware labeling.
    """
