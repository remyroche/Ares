...
async def run_validator(...) -> ...:
    ...
    passpasslogger.error(f"❌ Found {negative_prices} negative price values")
        return {
                    "step_name": "step02_data_reading",
    ...
    passpasspasspasspasspasspasslogger.error(f"❌ Error reading data files: {e}")
        return {
    ...
    passpasspasspasspasspasspasslogger.exception(f"❌ Error in Step 2 validation: {e}")
        return {
            "step_name": "step02_data_reading",
