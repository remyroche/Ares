...
def simulate_merging_with_parameters(
    counts, centroids, min_frequency, similarity_threshold, max_regimes=None
):
            ...
            for max_reg in max_regimes_options:
                ...
                try:
                    result = simulate_merging_with_parameters(
                        counts, centroids, min_freq, sim_thresh, max_reg
                    )
