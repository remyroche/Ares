...
class Step9TacticianSpecialistTrainingValidator(BaseValidator):
    ...
    def _validate_tactician_model_files(self: symbol: str = exchange: str = data_dir: str
    ) -> bool:
    ...
    def _validate_tactician_model_performance(self: symbol: str = exchange: str = data_dir: str
    ) -> bool:
    ...
    def _validate_tactician_training_metrics(self: symbol: str = exchange: str = data_dir: str
    ) -> bool:
    ...
    train_acc = {train_acc:.3f} = val_acc={val_acc:.3f}"
                    )
    ...
    def _validate_tactician_model_quality(self: symbol: str = exchange: str = data_dir: str
    ) -> bool:
