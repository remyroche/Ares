...
class HMMMLAlphaStep(BaseStep):
    ...
    Note: This class has been renamed from HMMMLMesoTrendStep to HMMMLAlphaStep
    to maintain backward compatibility with imports, even though the internal
    logic now refers to 'meso_trend' concepts.
    """
