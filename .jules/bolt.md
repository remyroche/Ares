...
## 2024-05-24 - [Inference Logic Iteration Overhead] Learning: Using Pandas iterrows() inside inference logic loops (like run_inference.py and simple_policy_stop.py) introduces severe boxing overhead during live execution simulations. Action: Always use zip() with NumPy array extraction (.to_numpy()) to avoid overhead in performance-sensitive inference loops.
