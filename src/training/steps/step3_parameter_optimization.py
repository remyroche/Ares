...
class ParameterOptimizationStep:
    ...
    @secure_step_execution
    @validate_pipeline_step
    @handle_errors(exceptions=(Exception,), default_return=False, context="parameter_optimization_execution")
...
@handle_errors(exceptions=(Exception,), default_return=False, context="step3_parameter_optimization")
@secure_step_execution
