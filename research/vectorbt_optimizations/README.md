...
**Usage:**
```python
from research.vectorbt_optimizations import VectorBTCryptoOptimizer
...
**Usage:**
```python
from research.vectorbt_optimizations import VectorBTFeatureOptimizer
...
**Usage:**
```python
from research.vectorbt_optimizations import VectorBTProfitLabelingOptimizer
...
**Usage:**
```python
from research.vectorbt_optimizations import VectorBTPricePatternsOptimizer
...
**Usage:**
```python
from research.vectorbt_optimizations import VectorBTClusteringOptimizer
...
```python
from research.vectorbt_optimizations import (
...
from research.crypto_analysis.optimized_crypto_processor import OptimizedCryptoProcessor
from research.vectorbt_optimizations import VectorBTCryptoOptimizer
