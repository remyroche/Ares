...
This module provides configuration settings for the enhanced multi-timeframe optimizer
that uses optimized lookback periods from the matrix optimization system.
"""
    ...
    return {
        ...
        "cross_timeframe_optimization": {
            ...
            "feature_types": {
                ...
                "range": {"enabled": True, "methods": ["ratio", "difference"]},
            },
        },
...
def get_quality_validation_config() -> Dict[str, Any]:
    ...
    return {
        "variance_threshold": 1e-12,
        "correlation_thresholds": {"min_with_target": 0.3, "max_between_features": 0.8},
        "information_score_threshold": 0.05,
        "diversity_score_threshold": 0.2,
        "stability_threshold": 0.7,
        "validation_methods": [
