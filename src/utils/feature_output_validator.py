...
class FeatureOutputValidator:
    ...
    def validate_feature_output(
        ...
        method_name: str,
        input_data_shape: Optional[Tuple[int, int]] = None,
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if features_df is None or features_df.empty:
                ...
                if "engineer_features" in method_name.lower():
                    ...
                    validation_results["output_quality_score"] = 0.5  # Give a neutral score
            ...
            self.logger.error(f"Error during feature output validation: {e}")
            validation_results["validation_passed"] = False
    ...
    def _convert_features_to_dataframe(
        ...
        try:
            ...
            self.logger.error(f"💥 [FEATURE OUTPUT VALIDATION] Error converting features to DataFrame: {e}")
            return None
    ...
    def _validate_output_structure(
        ...
        if empty_features:
            results["warnings"].append(
                f"Empty features detected: {empty_features}"
            )
    ...
    def _validate_downstream_compatibility(
        ...
        regime_compatible = self._validate_regime_compatibility(
