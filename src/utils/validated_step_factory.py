...
class ValidatedStepFactory:
    ...
    def create_all_validated_steps(self) -> Dict[str, Type]:
        ...
        step_imports = {
            ...
            'step02_5_sr_optimization': ('src.training.steps.market_analysis.sr_optimization_compatibility', 'SROptimizationStep'),
            'step2_5_sr_optimization': ('src.training.steps.market_analysis.sr_optimization_compatibility', 'SROptimizationStep'),
