"""
Enhanced Analyst Models Training with MSM and Attention Mechanisms

This module provides enhanced analyst model training with:
...
@dataclass
class EnhancedAnalystConfig:
    """Configuration for enhanced analyst training."""
    ...
    def __post_init__(self):
        if self.model_types is None:
            self.model_types = [
                ModelType.CATBOOST_ATTENTION,
                ModelType.LIGHTGBM_ATTENTION,
                ModelType.XGBOOST_ATTENTION
            ]
...
class EnhancedAnalystTrainer:
    """Enhanced analyst trainer with MSM and attention mechanisms."""
    
    def __init__(self, config: EnhancedAnalystConfig):
        """Initialize enhanced analyst trainer."""
        self.config = config
        self.logger = system_logger.getChild('EnhancedAnalystTrainer')
    ...
    def train(self, X: np.ndarray, y: np.ndarray, 
        ...
        try:
            ...
            tprint_success("✅ Enhanced analyst training completed successfully")
    ...
    def predict(self, X: np.ndarray) -> np.ndarray:
        ...
        return self._ensemble_predict(ensemble_model, X)
