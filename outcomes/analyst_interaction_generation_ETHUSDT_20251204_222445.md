...
- **Feature Density**: 0.8 features per category
- **Interaction Ratio**: 77.8%

## Category Coverage Analysis
- 🔴 **Trend**: 1 features (Poor)
- 🟠 **Oscillator**: 2 features (Adequate)
- 🔴 **Momentum**: 0 features (Poor)
- 🔴 **Returns**: 0 features (Poor)
- 🟠 **Volatility**: 4 features (Adequate)
- 🔴 **Volume**: 1 features (Poor)
- 🔴 **Acceleration**: 0 features (Poor)
- 🔴 **Entropy**: 0 features (Poor)
- 🔴 **Spectral_Wavelet**: 0 features (Poor)
- 🔴 **Support_Resistance**: 0 features (Poor)
- 🔴 **Unknown**: 1 features (Poor)
...
- **Top 10 features by gain:**
  - `order_flow_imbalance_20_vwap`: 0.0000
  - `order_flow_imbalance_20_base`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_minus_fibonacci_0.786_20_price_returns_base_9x_ratio`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_log_ratio_fibonacci_0.786_20_price_returns_base_9x_ratio`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_div_order_flow_imbalance_20_vwap`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_x_order_flow_imbalance_20_base`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_minus_order_flow_imbalance_20_base`: 0.0000
  - `vectorbt_atr_14_base_6x_ratio_log_ratio_order_flow_imbalance_20_base`: 0.0000
  - `volume_ema_10_volnorm_log_ratio_order_flow_imbalance_20_vwap`: 0.0000
...
2. **Feature Quality**: ⚠️ Consider generating more features
...
*Generated on 2025-12-04 22:24:45*
