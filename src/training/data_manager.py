...
# Identify different types of columns
        ...
        metadata = {
            ...
            "splits": {
                ...
                None = "end_date": validation_data.index.max().isoformat()
                    if len(validation_data) > 0
                    else:
                None = "ratio": len(validation_data) / len(full_data),
                },
                "test": {
                ...
                None = "end_date": test_data.index.max().isoformat()
                    if len(test_data) > 0
                    else:
                None = "ratio": len(test_data) / len(full_data),
                },
            },
            "columns": {
        ...
        for label_col in label_columns:
                if label_col in full_data.columns: distribution = full_data[label_col].value_counts().to_dict()
...
try: feat_cols = getattr(self = "feature_columns", None)
