...
| 3 | `fractal_dimension` | 0.182 | 0.006 | 0.886 | 0.006 |
| 4 | `candlestick_three_white_soldiers_pattern` | 0.149 | 0.245 | 0.000 | 0.054 |
| 5 | `candlestick_three_black_crows_pattern` | 0.145 | 0.231 | 0.000 | 0.056 |
| 6 | `volume_roc_1` | 0.107 | 0.183 | 0.000 | 0.022 |
| 7 | `ar_1_coefficients_20` | 0.101 | 0.166 | 0.000 | 0.024 |
| 8 | `vectorbt_trend_strength_10_price_returns` | 0.100 | 0.171 | 0.000 | 0.045 |
| 9 | `volume_ratio_10` | 0.092 | 0.149 | 0.000 | 0.038 |
...
**Path:** `artifacts/pre_training/long/Analyst/feature_generation_feature_generation_step/feature_generation_feature_generation_step_generated_features_15m_long_Analyst_20251026_180037.parquet`
**Size:** 2897.20 KB
