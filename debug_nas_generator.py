#!/usr/bin/env python3
"""
Debug script to isolate the NAS detector generator error.
"""
...
def test_nas_detector():
    """Test the NAS detector to isolate the generator error."""
    try:
        logger.info("Starting NAS detector test...")

        # Import the NAS detector
        from training.steps.market_analysis.nas_regime.core.perfect_nas_regime_detector import PerfectNASRegimeDetector
        from training.steps.market_analysis.nas_regime.core.perfect_nas_config import PerfectNASConfig, NeuralArchitectureType
        ...
        logger.info("Created PerfectNASConfig")
        ...
        # Create the detector
        logger.info("Creating PerfectNASRegimeDetector...")
        detector = PerfectNASRegimeDetector(config)
        logger.info("PerfectNASRegimeDetector created successfully")
