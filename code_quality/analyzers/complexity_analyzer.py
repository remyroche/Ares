...
class ComplexityAnalyzer:
    ...
    def analyze_file(self, file_path: str | Path) -> ModuleComplexity:
        """
    ...
    def analyze_directory(self, directory: str | Path) -> dict[str, ModuleComplexity]:
        """
    ...
    def analyze_files(self, file_paths: list[str | Path]) -> dict[str, ModuleComplexity]:
        """
