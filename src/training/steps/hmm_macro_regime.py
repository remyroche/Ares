            ...
            if config.get("macro_trend_enable_quality_report", True):
                try:
                    ...
                    if report_result is not None:
                        ...
                        tprint_info(f"📄 Generated HMM macro trend quality report: {md_path}")
                except Exception as report_exc:
                    tprint_warning(f"Failed to generate HMM macro trend quality report: {report_exc}")
    ...
    def _generate_hmm_macro_quality_report(
        ...
        *,
        ...
        try:
            ...
            base_name = f"hmm_macro_trend_quality_{symbol}_{timeframe}_{now_str}"
            ...
            with open(csv_path, 'w') as f:
                f.write("# HMM Macro Trend Quality Report\n")
            ...
            tprint_warning(f"Failed to generate HMM macro trend quality report: {e}")
            import traceback
            traceback.print_exc()
            return None
