...
class IntelligentFeatureCache:
    ...
    def __init__(self, 
        ...
        logger.info(f"🔧 Initialized IntelligentFeatureCache:")
    ...
    def _load_from_disk(self, cache_key: str) -> Optional[Tuple[Any, dict]]:
        """
    ...
    def set(self, cache_key: str, data: Any, metadata: Optional[dict] = None):
        """
        Store data in cache.
