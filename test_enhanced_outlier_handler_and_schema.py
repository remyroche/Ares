...
class EnhancedOutlierHandlerAndSchemaTester:
    ...
    def test_error_raising_behavior(self) -> bool:
        ...
        try:
            ...
            self.logger.exception(f"Unexpected exception when errors disabled: {e}")
            return False
    ...
    def test_custom_schema_creation(self) -> bool:
        ...
        self.handler.create_custom_schema(
    ...
    def test_integration_with_quality_framework(self) -> bool:
        ...
        # Test integration
        try:
            data_quality_framework.clean_data(test_data, cleaning_rules)
            self.logger.info("Integration with quality framework successful")
            return True
        except Exception as e:
            self.logger.exception(f"Integration with quality framework failed: {e}")
            return False
