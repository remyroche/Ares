...
class AnalystEnsembleCreationStep:
    ...
    def _create_ensemble(
        self = ensemble_models: dict[str, Any], symbol: str, exchange: str, data_dir: str, ) -> dict[str, Any]:
    ...
    def _save_ensemble_summary(
        self = ensemble_result: dict[str, Any], symbol: str, exchange: str, data_dir: str, ) -> None:
...
def step7_analyst_ensemble_creation(symbol: str, exchange: str, data_dir: str, training_input: dict[str, Any], config: dict[str, Any], ) -> bool:
