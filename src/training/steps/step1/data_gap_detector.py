...
class DataGapDetector:
    ...
    def _detect_missing_aggtrades(self, symbol: str, exchange: str,
    ...
    def _detect_missing_klines(self, symbol: str, exchange: str,
                              start_date: datetime, end_date: datetime) -> dict:
        """Detect missing klines monthly files."""
        # Get both CSV and Parquet files
    ...
    def _detect_missing_futures(self, symbol: str, exchange: str,
                               start_date: datetime, end_date: datetime) -> dict:
        """Detect missing futures monthly files."""
        # Get both CSV and Parquet files
