...
MARKET_LIQUIDATION_OI_FEATURES = _dedupe(
    [
        "mkt_oi_chg_15m",
        "mkt_oi_chg_1h",
        "mkt_oi_chg_4h",
...
MARKET_LIQUIDATION_FUNDING_FEATURES = _dedupe(
    [
        "mkt_funding_mean",
        "mkt_funding_median",
...
MARKET_LIQUIDATION_OHLCV_FEATURES = _dedupe(
    [
        "pct_assets_up_15m",
        "pct_assets_up_1h",
        "pct_assets_up_4h",
...
MARKET_LIQUIDATION_COMPOSITE_FEATURES = _dedupe(
    [
...
FAMILY_REGIME_SPECS = [
    ...
    {
        "base_name": "family_liquidation_lifecycle",
        "feature_families": [
            "market_liquidation_oi",
            "market_liquidation_funding",
            "market_liquidation_ohlcv",
            "market_liquidation_composite",
            "cross_asset",
            "cross_sectional",
        ],
        "regime_family": "liquidation_lifecycle",
        "regime_objective": "liquidation_onset_climax_and_post_liquidation_rebound_detection",
        "market_summary": True,
    },
    {
...
UNSUPERVISED_REGIME_FEATURE_GROUPS = {
    ...
    "market_liquidation_oi_features": MARKET_LIQUIDATION_OI_FEATURES,
    "market_liquidation_funding_features": MARKET_LIQUIDATION_FUNDING_FEATURES,
    "market_liquidation_ohlcv_features": MARKET_LIQUIDATION_OHLCV_FEATURES,
    "market_liquidation_composite_features": MARKET_LIQUIDATION_COMPOSITE_FEATURES,
