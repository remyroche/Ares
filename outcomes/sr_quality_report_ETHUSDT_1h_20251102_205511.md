...
|------|------------|----------|----------|--------|---------|--------------|
| 1 | 0.0072 | 0.0072 | -0.000 | -0.000 | 0.0069 | 1 |
| 2 | 0.0072 | 0.0073 | 0.000 | -0.004 | 0.0070 | 1 |
| 3 | 0.0072 | 0.0072 | 0.000 | -0.001 | 0.0069 | 1 |

### Average Performance:

- **Validation RMSE:** 0.0072 ± 0.0000
- **Validation R²:** -0.002 ± 0.002
- **Validation MAE:** 0.0069
...
|-----------------|-------|----------------|-------------|-------|--------|
| 0.0-0.1 | 7816 | 0.001 | 0.001 | 0.000 | ✅ |
...
|-------------|---------|-----|------|------|-----|
| Low (0.0-0.3) | 2882 | 0.0094 | 0.0094 | -0.0094 | -224.285 |
