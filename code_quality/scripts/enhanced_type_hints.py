...
class TypeHintEnhancer(ast.NodeTransformer):
    ...
    def _infer_param_type(self, param_name: str) -> Optional[str]:
    ...
    def _infer_return_type(self, func_name: str, node: ast.FunctionDef, is_async: bool) -> Optional[str]:
                ...
                for node in ast.walk(tree):
                    if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)):
                        ...
                        if has_return_type and (not params or has_param_types):
                            ...
                            if file_path not in files_needing_hints:
