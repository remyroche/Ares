...
def _enable_numpy_rng_unpickle_compat(logger: Optional[Logger] = None) -> None:
    """Enable NumPy RNG unpickle compatibility shim.
...
class ModelManager:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.logger: Logger = system_logger.getChild("ModelManager")
    ...
    async def save_model(
        ...
        Args:
            ...
            format: Format to save in (joblib, pickle, h5)
    ...
    async def get_active_model(self) -> Optional[str]:
        ...
        Returns:
            Name of the active model or None
        """
    ...
    def get_model_status(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with model manager status
        """
        return {
    ...
    async def stop(self) -> None:
        """Stop the model manager and cleanup resources."""
...
async def setup_model_manager(config: Optional[Dict[str, Any]] = None) -> Optional[ModelManager]:
    """Set up the global model manager.
    
    Args:
        config: Optional configuration dictionary
        
    Returns:
        Initialized model manager or None if setup failed
    """
