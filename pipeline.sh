...
echo ""
echo "🚀 Usage Examples:"
echo "   ./pipeline.sh light   # Fast testing (30 days, 5% compute)"
echo "   ./pipeline.sh blank   # Medium testing (180 days, 25% compute)"
echo "   ./pipeline.sh full    # Production (730 days, 100% compute)"