...
class StepDependencyValidator:
    ...
    "step2_5_enhanced_matrix_operations": ["step2_data_reading"],
    "step3_hmm_regime_discovery": ["step2_5_enhanced_matrix_operations"],
    ...
    "step6_feature_engineering": ["step2_5_enhanced_matrix_operations", "step5_labeling"],
    "step7_feature_engineering": ["step2_5_enhanced_matrix_operations", "step6_feature_engineering"],
            "step8_regime_data_splitting": ["step7_feature_engineering"],
