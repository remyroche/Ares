...
class DIIntegration:
    ...
    async def demonstrate_full_di_integration(self) -> dict[str, Any]:
        ...
        try:
            ...
            complete_system = {**infrastructure, **trading_components, **specialized_services}
    ...
    async def _create_infrastructure(self) -> dict[str, Any]:
        ...
        infrastructure = {'event_bus': event_bus}
    ...
    def get_integration_status(self) -> dict[str, Any]:
        ...
        return {'is_initialized': self.is_initialized, 'components': list(self.system_components.keys()), 'container_services': list(self.container.get_all_services().keys())}
