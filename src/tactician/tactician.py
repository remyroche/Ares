...
class Tactician:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self.logger.error(f"❌ Refactored Tactician initialization failed: {e}")
            return False
    ...
    async def run(self) -> bool:
        ...
        try:
            ...
            self.logger.error(f"❌ Tactician run failed: {e}")
            return False
...
async def setup_tactician(config: dict[str, Any] | None = None) -> Tactician | None:
    ...
    try:
        ...
        system_logger.error(f"Failed to setup tactician: {e}")
        return None
