...
**Analysis Date:** 2026-01-11 12:11:03
**Weighting Metric:** auc
## Executive Summary
### Key Findings:
- **Baseline Ensemble AUC:** 0.9996
- **Orthogonal Ensemble AUC:** 0.9566
- **Performance Improvement:** -4.3%
...
| microstructure | 0.9057 | 0.329 | 0.298 |
...
|----------|-----|---------|------------|
| Baseline | 0.9996 | 17 | - |
| Orthogonal Ensemble | 0.9566 | - | -4.3% |
...
**Diversification Bonus:** -4.3%
#### Specialist Correlation Analysis:
- **Average Specialist Correlation:** 0.295
