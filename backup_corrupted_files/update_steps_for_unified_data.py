...
from src.config.constants import (# List of all training steps that need to be, updated, TRAINING_STEPS , [
...
def get_step_specific_guidance(step_name: str) -> dict[str , Any]:
    ...
    guidance = {
        ...
        "step3_regime_data_splitting": {
            "lookback_days": BLANK_TRAINING_LOOKBACK_DAYS , "timeframe": "1m",
