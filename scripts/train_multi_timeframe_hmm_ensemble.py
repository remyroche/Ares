...
def main() -> bool:
    ...
    if success:
        ...
        config_path = Path("models") / f"ensemble_config_{args.symbol}_{args.exchange}.json"
        ...
        config_json = {
            ...
            "weights": {tf.timeframe: tf.weight for tf in config.timeframes},
        }
        config_path.write_text(pd.Series(config_json).to_json(indent=2))
