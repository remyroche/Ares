...
|------|--------------|----------|----------------|--------------|------------|-----------|-----------|
| 1 | simple_returns_1_price_returns | returns | 0.297 | 0.991 | 0.000 | 0.991 | 0.465 |
| 2 | log_returns_10_price_returns | returns | 0.297 | 0.969 | 0.000 | 0.990 | 0.453 |
| 3 | log_returns_1_price_returns | returns | 0.296 | 0.985 | 0.000 | 0.993 | 0.466 |
| 4 | log_returns_5_price_returns | returns | 0.296 | 0.979 | 0.000 | 0.992 | 0.459 |
| 5 | cumulative_returns_10_price_returns | returns | 0.297 | 0.969 | 0.000 | 0.991 | 0.456 |
| 6 | simple_returns_10_price_returns | returns | 0.298 | 0.980 | 0.000 | 0.992 | 0.457 |
| 7 | simple_returns_5_price_returns | returns | 0.297 | 0.984 | 0.000 | 0.991 | 0.460 |
| 8 | rolling_returns_10_price_returns | returns | 0.297 | 0.967 | 0.000 | 0.991 | 0.455 |
| 9 | returns_volatility_20_price_returns | returns | 0.297 | 0.955 | 0.000 | 0.976 | 0.448 |
| 10 | rolling_returns_20_price_returns | returns | 0.297 | 0.959 | 0.000 | 0.992 | 0.457 |
| 11 | sharpe_ratio_20_0.0_price_returns | returns | 0.296 | 0.950 | 0.000 | 0.960 | 0.456 |
| 12 | advanced_cumulative_returns_10 | returns | 0.296 | 0.974 | 0.000 | 0.970 | 0.483 |
| 13 | cumulative_returns_20_price_returns | returns | 0.297 | 0.961 | 0.000 | 0.992 | 0.457 |
| 14 | returns_kurtosis_20_price_returns | returns | 0.297 | 0.945 | 0.000 | 0.973 | 0.454 |
| 15 | returns_skewness_20_price_returns | returns | 0.296 | 0.951 | 0.000 | 0.957 | 0.448 |
| 16 | rolling_zscore_returns_20 | returns | 0.297 | 0.957 | 0.000 | 0.992 | 0.508 |
| 17 | advanced_cumulative_returns_20 | returns | 0.297 | 0.954 | 0.000 | 0.962 | 0.476 |
| 18 | momentum_features | momentum | 0.297 | 0.995 | 0.000 | 0.960 | 0.486 |
| 19 | ar_1_coefficients_20 | entropy | 0.297 | 0.946 | 0.000 | 0.965 | 0.442 |
| 20 | ljung_box_pvalue_20_10 | other | 0.296 | 0.926 | 0.000 | 0.960 | 0.437 |
...
| **Calinski-Harabasz** | 2.0 | > 100 | ❌ FAIL |
| **Davies-Bouldin** | 0.851 | < 2.0 | ✅ PASS |
...
- **Economic Significance Weight**: 35.0%
