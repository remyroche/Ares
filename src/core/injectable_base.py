...
@property def is_initialized(self) -> bool: """Check if component is initialized.""" return self._initialized   class TradingComponentBase(InjectableBase): pass  # TODO: Add implementation class TradingComponentBase(InjectableBase): pass  # TODO: Add implementation class TradingComponentBase(InjectableBase): """ Base class for core trading components (Analyst, Strategist, Tactician, Supervisor).  Provides common dependencies and functionality needed by all trading components. """  def __init__( self, config: dict[str, Any] | None = None, exchange_client: IExchangeClient | None = None, state_manager: IStateManager | None = None, event_bus: IEventBus | None = None, ): super().__init__(config)
