...
class DILauncher:
    ...
    async def launch_paper_trading(self, symbol: str, exchange: str) -> dict[str, Any]:
        ...
        try:
            ...
            # Create full system
            self.system_components = await self.factory.create_full_system(trading_config)
            ...
            self.logger.error(f"Failed to launch paper trading: {e}")
            raise
    ...
    async def launch_live_trading(self, symbol: str, exchange: str) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Failed to launch live trading: {e}")
            raise
    ...
    async def launch_backtesting(self, symbol: str, exchange: str) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Failed to launch backtesting: {e}")
            raise
    ...
    async def _create_training_system(self, config: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Failed to create training system: {e}")
            raise
...
async def launch_paper_trading(symbol: str, exchange: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
...
async def launch_live_trading(symbol: str, exchange: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
    """Quick launch function for live trading."""
    launcher = DILauncher(config)
    return await launcher.launch_live_trading(symbol, exchange)


async def launch_backtesting(symbol: str, exchange: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
    """Quick launch function for backtesting."""
    launcher = DILauncher(config)
    return await launcher.launch_backtesting(symbol, exchange)


async def launch_training(symbol: str, exchange: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
