...
async def run_pipeline_with_step08(symbol: str='BTCUSDT', exchange: str='binance', timeframe: str='1m', start_step: str='step06_feature_engineering') -> Any:
    ...
    config = {'symbol': symbol, 'exchange': exchange, 'timeframe': timeframe, 'step07_enhanced_matrix_operations': {'output_dir': 'data/matrix_operations', 'target_features': 200, 'removal_fraction': 0.33, 'enable_regime_selection': True, 'enable_shap_filtering': True}, 'step08_advanced_feature_selection': {'output_dir': 'data/selected_features', 'phase1_target_features': 150, 'enable_mrmr': True, 'enable_rf_importance': True, 'phase2_targets': [100, 80, 60], 'boruta_max_iter': 100, 'boruta_alpha': 0.05, 'n_splits_ts': 5, 'min_regime_samples': 100, 'enable_shap': True, 'enable_lime': True, 'n_lime_samples': 10, 'enable_redundancy_analysis': True, 'min_redundancy_correlation': 0.7, 'redundancy_groups_per_concept': 2, 'n_jobs': -1}, 'training': {'start_step': start_step, 'force_rerun': False, 'validate_each_step': True}}
