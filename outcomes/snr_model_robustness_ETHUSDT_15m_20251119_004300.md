...
- Pseudo-R^2 95% CI: [-0.0376, -0.0309]
...
- Residual pattern strength (max - min mean residual across probability deciles): 0.2578
- Residual lag-1 autocorrelation: 0.5502

## Model Family Comparison (LightGBM vs LogisticRegression)
- Mean AUC LightGBM: 0.5406 | LogisticRegression: 0.5421
