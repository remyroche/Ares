...
class SignatureAnalyzer:
    ...
    def _extract_function_signature(self, node: ast.FunctionDef, file_path: str) -> FunctionSignature:
        ...
        if node.args.defaults:
            ...
            for i in range(num_args - num_defaults):
    ...
    def _extract_function_call(self, node: ast.Call, file_path: str) -> Optional[FunctionCall]:
    ...
    def _check_call_compatibility(self, call: FunctionCall, func_def: FunctionSignature) -> List[str]:
        ...
        required_args = []
        for i, (arg, default) in enumerate(zip(func_def.args, func_def.defaults)):
            if default is None:
    ...
    def _is_special_function(self, func: FunctionSignature) -> bool:
        ...
        # Check decorators
        if any(decorator in str(func.decorators) for decorator in special_decorators):
            return True
