    ...
    async def execute(self,
        ...
        try:
            ...
            if generation_result.success:
                self.logger.info(f"✅ Interaction generation completed successfully with {len(generation_result.interaction_features.columns)} interaction features")
            else:
                self.logger.error(f"❌ Interaction generation failed: {generation_result.error_message}")
