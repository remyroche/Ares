...
class PipelineConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Convert configuration to dictionary."""
        return {'step01': self.step01.to_dict(), 'step1_5': self.step1_5.to_dict(), 'environment': self.environment, 'log_level': self.log_level, 'enable_metrics': self.enable_metrics, 'enable_profiling': self.enable_profiling, 'default_symbol': self.default_symbol, 'default_exchange': self.default_exchange, 'default_timeframe': self.default_timeframe}
...
class ConfigManager:
    ...
    def save_config(self, config: PipelineConfig, config_name: str='pipeline_config.json') -> None:
...
def validate_and_save_config(config: PipelineConfig, config_name: str='pipeline_config.json') -> bool:
    ...
    if config_manager.validate_config(config):
        ...
        return False
DEVELOPMENT_CONFIG = {'step01': {'max_memory_mb': 512, 'chunk_size': 5000, 'max_retries': 2, 'log_level': 'DEBUG'}, 'step1_5': {'max_memory_mb': 512, 'chunk_size': 5000, 'max_retries': 2, 'enable_incremental': True}, 'environment': 'development', 'log_level': 'DEBUG', 'enable_profiling': True}
STAGING_CONFIG = {'step01': {'max_memory_mb': 2048, 'chunk_size': 10000, 'max_retries': 3}, 'step1_5': {'max_memory_mb': 2048, 'chunk_size': 10000, 'max_retries': 3, 'enable_incremental': True}, 'environment': 'staging', 'log_level': 'INFO', 'enable_profiling': False}
PRODUCTION_CONFIG = {'step01': {'max_memory_mb': 4096, 'chunk_size': 20000, 'max_retries': 5, 'circuit_breaker_failure_threshold': 3}, 'step1_5': {'max_memory_mb': 4096, 'chunk_size': 20000, 'max_retries': 5, 'enable_incremental': True, 'circuit_breaker_failure_threshold': 3}, 'environment': 'production', 'log_level': 'WARNING', 'enable_profiling': False}