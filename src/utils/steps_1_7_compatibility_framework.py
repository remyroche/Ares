...
class StepContract:
    ...
    def __init__(self, step_name: str, inputs: dict[str, Any], outputs: dict[str, Any]) -> None:
...
class Steps1_7CompatibilityFramework:
    ...
    STEP_CONTRACTS = {'step01_data_collection': {'inputs': {'config': {'type': 'dict', 'required': True}, 'symbol': {'type': 'str', 'required': True}, 'exchange': {'type': 'str', 'required': True}, 'timeframe': {'type': 'str', 'required': True}}, 'outputs': {'klines_data': {'type': 'DataFrame', 'required': True, 'schema': 'klines'}, 'aggtrades_data': {'type': 'DataFrame', 'required': True, 'schema': 'aggtrades'}, 'data_paths': {'type': 'dict', 'required': True}, 'metadata': {'type': 'dict', 'required': True}}}, 'step01_5_data_converter': {'inputs': {'klines_data': {'type': 'DataFrame', 'required': True, 'schema': 'klines'}, 'aggtrades_data': {'type': 'DataFrame', 'required': True, 'schema': 'aggtrades'}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'unified_data': {'type': 'DataFrame', 'required': True, 'schema': 'unified'}, 'conversion_metadata': {'type': 'dict', 'required': True}}}, 'step02_data_reading': {'inputs': {'unified_data': {'type': 'DataFrame', 'required': True, 'schema': 'unified'}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'validated_data': {'type': 'DataFrame', 'required': True, 'schema': 'unified'}, 'validation_report': {'type': 'dict', 'required': True}, 'quality_metrics': {'type': 'dict', 'required': True}}}, 'step03_hmm_regime_discovery': {'inputs': {'validated_data': {'type': 'DataFrame', 'required': True, 'schema': 'unified'}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'regime_labels': {'type': 'DataFrame', 'required': True, 'schema': 'regime_labels'}, 'hmm_model': {'type': 'object', 'required': True}, 'regime_metadata': {'type': 'dict', 'required': True}}}, 'step04_regime_data_splitting': {'inputs': {'validated_data': {'type': 'DataFrame', 'required': True, 'schema': 'unified'}, 'regime_labels': {'type': 'DataFrame', 'required': True, 'schema': 'regime_labels'}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'regime_datasets': {'type': 'dict', 'required': True}, 'splitting_metadata': {'type': 'dict', 'required': True}}}, 'step05_labeling': {'inputs': {'regime_datasets': {'type': 'dict', 'required': True}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'labeled_datasets': {'type': 'dict', 'required': True}, 'labeling_metadata': {'type': 'dict', 'required': True}}}, 'step06_feature_engineering': {'inputs': {'labeled_datasets': {'type': 'dict', 'required': True}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'feature_datasets': {'type': 'dict', 'required': True}, 'feature_metadata': {'type': 'dict', 'required': True}, 'feature_importance': {'type': 'dict', 'required': True}}}, 'step07_enhanced_matrix_operations': {'inputs': {'feature_datasets': {'type': 'dict', 'required': True}, 'config': {'type': 'dict', 'required': True}}, 'outputs': {'processed_datasets': {'type': 'dict', 'required': True}, 'processing_metadata': {'type': 'dict', 'required': True}, 'matrix_operations': {'type': 'dict', 'required': True}}}}
    DATA_SCHEMAS = {'klines': {'required_columns': ['timestamp', 'open', 'high', 'low', 'close', 'volume'], 'optional_columns': ['quote_asset_volume', 'number_of_trades', 'taker_buy_base_asset_volume', 'taker_buy_quote_asset_volume'], 'data_types': {'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64'}}, 'aggtrades': {'required_columns': ['timestamp', 'price', 'quantity'], 'optional_columns': ['first_trade_id', 'last_trade_id', 'trade_time', 'is_buyer_maker'], 'data_types': {'timestamp': 'int64', 'price': 'float64', 'quantity': 'float64'}}, 'unified': {'required_columns': ['timestamp', 'open', 'high', 'low', 'close', 'volume', 'price', 'quantity'], 'optional_columns': ['regime', 'label', 'split'], 'data_types': {'timestamp': 'int64', 'open': 'float64', 'high': 'float64', 'low': 'float64', 'close': 'float64', 'volume': 'float64', 'price': 'float64', 'quantity': 'float64'}}, 'regime_labels': {'required_columns': ['timestamp', 'regime'], 'optional_columns': ['regime_probability', 'regime_confidence'], 'data_types': {'timestamp': 'int64', 'regime': 'int64'}}}
            ...
            if 'timestamp' in df.columns and reference_timestamps:
                ...
                if df_timestamps != reference_timestamps:
                    ...
                    if missing_timestamps or extra_timestamps:
                        consistency_issues.append(f'Timestamp mismatch in {step}: missing={len(missing_timestamps)}, extra={len(extra_timestamps)}')
    ...
    def get_compatibility_report(self, step_name: str | None=None) -> dict[str, Any]:
        ...
        report = {'total_checks': len(filtered_history), 'passed_checks': len([h for h in filtered_history if h['result']]), 'failed_checks': len([h for h in filtered_history if not h['result']]), 'by_check_type': {}, 'by_step': {}, 'recent_issues': []}
