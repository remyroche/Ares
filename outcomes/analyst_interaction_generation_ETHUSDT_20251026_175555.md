...
- **Generated**: 2025-10-26 17:55:55
- **Total Features Generated**: 71
...
- **Total Features**: 71
- **Base Features**: 40
- **Interaction Features**: 31
- **Feature Density**: 6.5 features per category
- **Interaction Ratio**: 43.7%

## Category Coverage Analysis
- 🟢 **Trend**: 37 features (Excellent)
- 🟢 **Oscillator**: 13 features (Excellent)
- 🟠 **Momentum**: 2 features (Adequate)
- 🔴 **Returns**: 1 features (Poor)
- 🟡 **Volatility**: 8 features (Good)
- 🟡 **Volume**: 9 features (Good)
- 🔴 **Acceleration**: 0 features (Poor)
- 🔴 **Advanced_Statistical**: 1 features (Poor)
...
- **Phase 1 Time**: 0.71s
- **Phase 2 Time**: 2.96s
- **Phase 3.1 Time**: 1.54s
- **Phase 3.2 Time**: 1.53s
- **Phase 3.3 Time**: 3.28s
- **Phase 4 Time**: 0.00s
- **Total Time**: 0.00s
- **Processing Efficiency**: 0.0 features/second
- **Memory Usage**: 0.0 MB
...
- **Interaction Success Rate**: 62.0%
- **Top Interaction Examples**:
  1. `fibonacci_0.618_20_price_returns_vwap_minus_order_flow_imbalance_20_vwap` (Score: 0.1049)
  2. `fibonacci_0.618_20_price_returns_vwap_minus_vectorbt_enhanced_ad_line_20_base` (Score: 0.0813)
  3. `volume_price_trend_vwap_x_vectorbt_parkinson_volatility_50_trend_adj` (Score: 0.0790)
  4. `volume_price_trend_vwap_minus_volume_price_trend_base` (Score: 0.0712)
  5. `volume_price_trend_vwap_minus_vectorbt_enhanced_ad_line_20_trend_adj` (Score: 0.0628)
...
*Generated on 2025-10-26 17:55:55*
