...
def main() -> None:
    ...
    # The explicitly supplied and hashed map projection is authoritative.
    # Remove any carried map columns from a previously enriched ledger before
    # joining, otherwise pandas suffixes can hide accidental cross-producer
    # reuse.
    score = score.drop(
        columns=["__map_decision_ts__", "raw_expected_bps"], errors="ignore",
    )
