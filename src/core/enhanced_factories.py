...
class TradingSystemFactory:
    ...
    async def create_complete_trading_system(
        ...
        try:
            ...
            self.print(failed("Failed to create trading system: {e}"))
            raise
...
class ExchangeClientFactory:
    ...
    def create_exchange_client(
        ...
        try:
            ...
            self.print(failed("Failed to create exchange client: {e}"))
            raise
...
class StateManagerFactory:
    ...
    def create_state_manager(self, config: dict[str, Any]) -> IStateManager:
        ...
        try:
            ...
            self.print(failed("Failed to create state manager: {e}"))
            raise
...
class PerformanceReporterFactory:
    ...
    def create_performance_reporter(
        ...
        try:
            ...
            self.print(failed("Failed to create performance reporter: {e}"))
            raise
...
class DatabaseManagerFactory:
    ...
    def create_database_manager(self, config: dict[str, Any]) -> Any:
        ...
        try:
            ...
            self.print(failed("Failed to create database manager: {e}"))
            raise
    ...
    async def create_full_system(self, config: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            performance_reporter = self.performance_factory.create_performance_reporter(
                config.get("performance_reporter", {}),
                db_manager,
            )

            # Create trading components
            trading_components = (
                await self.trading_factory.create_complete_trading_system(
                    exchange_client,
                    state_manager,
            ...
            self.print(failed("Failed to create full system: {e}"))
            raise
