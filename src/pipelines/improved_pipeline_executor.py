        ...
        try:
            ...
            ml_predictions = {
                "price_target_confidences": {
                    "0.25%": analyst_confidence,
                    "0.5%": analyst_confidence * 0.9,
                    "0.75%": analyst_confidence * 0.8,
                    "1.0%": analyst_confidence * 0.7,
                },
                "adversarial_confidences": {
                    "0.25%": 1.0 - tactician_confidence,
                    "0.5%": (1.0 - tactician_confidence) * 0.9,
                    "0.75%": (1.0 - tactician_confidence) * 0.8,
                    "1.0%": (1.0 - tactician_confidence) * 0.7,
                },
