...
class EnhancedExecutionManager:
    ...
    async def initialize(self) -> bool:
        """Initialize EnhancedExecutionManager with async setup and validation.
        
        This method performs async initialization tasks including:
        - Configuration validation
        - Dynamic barrier calculator initialization
        ...
        try:
            ...
            # Ensure dynamic barrier calculator is initialized
            if not hasattr(self, 'barrier_calculator') or not self.barrier_calculator:
                self.logger.info("🔧 Initializing dynamic barrier calculator...")
                self._load_config()
            
            # Initialize performance tracking
            if not hasattr(self, 'execution_history'):
                self.execution_history: List[Dict[str, Any]] = []
            if not hasattr(self, 'precision_metrics'):
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        """Initialize the EnhancedExecutionManager with configuration.
    ...
    def _load_config(self) -> None:
        ...
        self.upper_barrier_pct, self.lower_barrier_pct = barrier_combinations[barrier_name]
    ...
    def validate_analyst_predictions(
        ...
        """Validate Analyst and Tactician predictions for execution.
        
        Args:
            analyst_predictions: Dictionary containing Analyst predictions
            tactician_predictions: Dictionary containing Tactician predictions
    ...
    def _determine_tactician_direction(self, confidence: float) -> str:
        """Determine Tactician trade direction based on confidence.
        
        Args:
            confidence: Confidence score from Tactician
    ...
    def _directions_agree(self, analyst_direction: str, tactician_direction: str) -> bool:
        """Check if Analyst and Tactician directions agree.
        
        Args:
            analyst_direction: Analyst trade direction
            tactician_direction: Tactician trade direction
            
        Returns:
            True if directions agree, False otherwise
        """
    ...
    def calculate_execution_parameters(
        ...
        """Calculate execution parameters for high precision trading.
    ...
    def _calculate_entry_timing(
        ...
        """Calculate entry timing based on confidence and market conditions.
    ...
    def _calculate_precision_score(
        ...
        """Calculate precision score for execution.
        
        Args:
            combined_confidence: Combined confidence from Analyst and Tactician
    ...
    async def execute_trade(
        ...
        Args:
            execution_params: Execution parameters from calculate_execution_parameters
    ...
    def _update_precision_metrics(self, execution_params: Dict[str, Any]) -> None:
        """Update precision metrics after trade execution.
        
        Args:
            execution_params: Execution parameters containing precision score
        """
        try:
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        """Get performance summary of executed trades.
