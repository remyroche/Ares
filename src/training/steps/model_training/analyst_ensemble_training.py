        ...
        try:
            ...
            if base_predictions and len(base_predictions) > 1:
                ...
                try:
                    ...
                    tprint(f"✅ [ANALYST_ENSEMBLE] Added {len(disagreement_features)} disagreement features", color="green")
                except ImportError as e:
                    tprint(f"⚠️ [ANALYST_ENSEMBLE] Could not import disagreement calculator: {e}", color="yellow")
