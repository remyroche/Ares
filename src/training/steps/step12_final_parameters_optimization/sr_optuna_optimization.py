...
from src.tactician.sr_weight_optimizer import SRWeightOptimizer, WeightOptimizationResult
...
class SROptunaOptimizer:
    ...
    def __init__(
        ...
        self.objectives = self.sr_config.get("objectives", [
            "sharpe_ratio", "win_rate", "signal_clarity"
        ])
        self.objective_weights = self.sr_config.get("objective_weights", {
            "sharpe_ratio": 0.4,
            "win_rate": 0.3,
            "signal_clarity": 0.3
        })
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self.logger.error(f"❌ Error initializing S/R optimizer: {e}")
            return False
    ...
    async def optimize_sr_parameters(
        ...
        try:
            ...
            # Define objective function (synchronous for Optuna)
    ...
    def _calculate_signal_clarity(self, signals: pd.Series, target_returns: pd.Series) -> float:
    ...
    def _calculate_noise_reduction(self, sr_features: Dict[str, pd.Series]) -> float:
        ...
        try:
            ...
            stability_scores = []
            for feature_name, feature_values in sr_features.items():
    ...
    def _create_optimization_result(
        ...
        try:
            ...
            strength_score_weights = {
                ...
                if k in ["touch_count", "total_volume", "level_age", "bounce_rate", "isolation_score"]
            }
            ...
            self.logger.error(f"Error creating optimization result: {e}")
            return None
