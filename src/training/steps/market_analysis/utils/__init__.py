"""Utils package for Step 7 Enhanced Matrix Operations.

This package contains modular components extracted from the original
step07_enhanced_matrix_operations.py to reduce complexity while maintaining
all functionality.
"""
...
__all__ = [
    'FunctionCallTracker',
    'comprehensive_function_tracker',
