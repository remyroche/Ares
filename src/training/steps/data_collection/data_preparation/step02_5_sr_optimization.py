    ...
    async def async_wrapper(*args, **kwargs):
        ...
        try:
            ...
            if func_name not in function_call_tracker["performance_metrics"]:
                function_call_tracker["performance_metrics"][func_name] = {
                    "total_calls": 0,
                    "total_time": 0,
                    "avg_time": 0,
                    "min_time": float('inf'),
...
def generate_function_report() -> Dict[str, Any]:
    ...
    report = {
        "summary": {
            ...
            "successful_calls": function_call_tracker["success_count"],
            "failed_calls": function_call_tracker["error_count"],
            "success_rate_percent": round(success_rate, 2),
            "report_generated_at": datetime.now().isoformat()
        },
        "performance_metrics": function_call_tracker["performance_metrics"],
        "call_history": function_call_tracker["call_history"][-50:],  # Last 50 calls
        "top_performing_functions": sorted(
            function_call_tracker["performance_metrics"].items(),
...
class SROptimizationStep(BaseStep):
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        # Initialize function call tracking for this instance
        self.instance_call_tracker = {
            "method_calls": 0,
            "method_history": [],
            "performance_metrics": {}
        }
    ...
    async def execute(self, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Add function call report to result
    ...
    async def execute_logic(
        ...
        try:
            ...
            internal_call_tracker["step_results"]["feature_engineering"] = {
                "success": True,
            ...
            internal_call_tracker["step_results"]["sr_detection"] = {
                "success": True,
            ...
            internal_call_tracker["step_results"]["ml_training"] = {
                "success": True,
            ...
            execution_report = {
                ...
                "step_breakdown": internal_call_tracker["step_times"],
                "step_results": internal_call_tracker["step_results"],
                "performance_summary": {
                    "features_per_second": len(features_data.columns) / execution_time,
                    "sr_levels_per_second": optimization_results['sr_levels_detected'] / execution_time,
            ...
            # Update internal tracker with error info
    ...
    async def _detect_sr_levels(self, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_metrics": {
                "total_candidates": resistance_candidates + support_candidates,
                "resistance_candidates": resistance_candidates,
                "support_candidates": support_candidates,
                "detection_time": detection_time,
                "resistance_detection_time": resistance_time,
                "support_detection_time": support_time
            }
        }
    ...
    async def _train_ml_models(self, data: pd.DataFrame, sr_levels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.logger.info(f"📊 Feature columns: {feature_columns[:10]}...")  # Show first 10
        ...
        return {
            ...
            "training_metrics": {
                "total_training_time": ml_time,
                "data_split_time": split_time,
                "feature_scaling_time": scale_time,
                "direction_training_time": direction_time,
                "volatility_training_time": volatility_time,
...
async def test():
    ...
    mock_data = pd.DataFrame({
        ...
        'high': base_price + np.cumsum(np.random.randn(n_samples) * 0.1) + np.random.rand(n_samples) * 2,
        'low': base_price + np.cumsum(np.random.randn(n_samples) * 0.1) - np.random.rand(n_samples) * 2,
