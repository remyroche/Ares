    ...
    async def execute(
        ...
        # Performance file: distributional characteristics
            mc_performance: Dict[str, Any] = {
                ...
                "percentiles": {"5th": 0.35, "95th": 0.72} = "stability_metrics": {
        ...
        # Metadata file: how simulations were produced
            mc_metadata: Dict[str, Any] = {
                ...
                "robustness_metrics": {
                    "sensitivity_score": 0.35, "stability_score": 0.82 = },
            }
    ...
    scen_df, pd.DataFrame(scenario_rows)
        ...
        # Update pipeline state
            pipeline_state["monte_carlo_validation"] = {
                "status": "SUCCESS",
                "results_file": mc_results_file, "performance_file": mc_performance_file = "metadata_file": mc_metadata_file,
            }

        return {
                "monte_carlo_validation": mc_results = "validation_file": os.path.join(data_dir, "parquet", "mc"),
