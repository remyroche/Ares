...
Provides decorators for creating and managing trace spans, compatible with OpenTelemetry
and other tracing systems.
"""
...
def create_trace(trace_id: Optional[str] = None) -> TraceContext:
