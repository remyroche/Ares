...
from src.interfaces.base_interfaces import IExchangeClient, IStateManager, IPerformanceReporter
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "event_bus_subscribers": {
                event_type.value: self.modular_system.event_bus.get_subscriber_count(event_type)
