...
class DIIntegration:
    ...
    async def _create_infrastructure(self) -> dict[str, Any]:
        ...
        performance_reporter = (
            self.factory.performance_factory.create_performance_reporter(
                self.config.get("performance_reporter", {}),
                db_manager,
            )
        )
    ...
    async def run_complete_demonstration(self) -> dict[str, Any]:
        ...
        try:
            ...
            ] = await self.demonstrate_configuration_injection()
    ...
    def get_container_metrics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "service_types": [service_type.__name__ for service_type in all_services],
            "singleton_count": len(
                [
                    s
