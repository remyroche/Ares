...
def monitor_function_calls_fallback(validation_level: ValidationLevel = ValidationLevel.STANDARD):
...
def validate_function_entry_fallback(function_type: str = 'generic'):
...
def handle_errors_fallback(fallback: bool = True):
