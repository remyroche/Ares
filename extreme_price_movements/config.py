...
CFG = {
    ...
    + RIDGE_FEATURE_COLS
    + HELPER_BASE_FEATURES,
    # Base Feature Keys: Union of TF and MR features for base model training
    "base_feature_keys": list(
        dict.fromkeys(
            (
                [
                    "retest_accept",
    ...
    "meta_feature_keys": [
        ...
        "z_r_24",
        "bb_pos_24",
        # Regime features from lgbm_based_mask_generation.py
        "bars_since_ema20_ema50_cross_log_norm",
        "bars_in_high_vol_state_log_norm",
        "bars_outside_ema20_atr_band_log_norm",
        "up_down_semivol_ratio_tanh",
    ...
    + [
        # MR Meta Features (kind-specific)
        "impulse_reversal",
        "impulse_reversal_short",
        "breakout_min",
        "pct_breakout_t",
    ...
    + [
        # TF Meta Features (kind-specific)
        "tf_tape",
        "accept_gt66",
        "retest_accept",
        "breakout_confirmed",
