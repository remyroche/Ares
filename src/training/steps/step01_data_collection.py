...
async def run_step()"
    ...
    exchange: str,""""
    timeframe: str = "1m",
    data_dir: str, None,  # Will be constructed as data_cache / exchange / asset / force_rerun: bool, False,"
    **kwargs: Any,"""
) -> bool:"""
...
"
        ...
        training_input = {}"""
            ...
            "project_version": CONFIG.get("project_version", "1.0_0") if CONFIG else "1.0_0",  # Default version
