...
class EnhancedDataCollectionStepWithMonitoring:
    ...
    def _validate_environment(self) -> None:
        ...
        # Log function call summary after environment validation
    ...
    async def initialize(self) -> None:
        ...
        # Log function call summary after initialization
        log_function_call_summary(self.logger)
    ...
    async def execute(self, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Run data collection with monitoring
            ...
            # Add monitoring results to pipeline state
    ...
    async def _run_monitored_data_collection(self, training_input: Dict[str, Any], data_dir: str) -> bool:
        ...
        try:
            ...
            # Try to use existing downloader with monitoring
            ...
            if download_success:
                ...
                # Validate downloaded data with monitoring
    ...
    async def _log_monitored_step1_artifacts_and_report(self, training_input: Dict[str, Any], pipeline_state: Dict[str, Any]) -> None:
        ...
        try:
            ...
            execution_metadata = {
                ...
                'monitoring_summary': pipeline_state.get('monitoring_summary', {})
            }
            ...
            metrics_calculated = {
                ...
                'function_calls_monitored': pipeline_state.get('monitoring_summary', {}).get('total_calls', 0),
                'function_call_success_rate': pipeline_state.get('monitoring_summary', {}).get('success_rate', 0.0)
            }
            
            # Create report data
            report_data = {
                'step_name': 'step01_enhanced_data_collection_with_monitoring',
                ...
                'monitoring_results': pipeline_state.get('monitoring_summary', {})
            }
...
@monitor_comprehensive
async def run_enhanced_step01_with_monitoring(
    symbol: str,
    exchange: str,
    timeframe: str = "1m",
...
if __name__ == '__main__':
    async def main():
        ...
        success = await run_enhanced_step01_with_monitoring(
            symbol=symbol,
            exchange=exchange,
            timeframe=timeframe,
            data_dir=data_dir,
