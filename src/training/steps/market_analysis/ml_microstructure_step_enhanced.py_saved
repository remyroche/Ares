    ...
    async def execute(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            output_df = self._create_standardized_output(
                features, full_labels, final_preds.values, final_probs.values, symbol, exchange, timeframe, direction
            )
            ...
            self._save_artifact(data=last_model, artifact_name=f"enhanced_microstructure_model_{timeframe}", artifact_type="model", data_category="models", metadata=metadata)
