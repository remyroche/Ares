...
async def run_step(symbol: str, exchange: str = "BINANCE", data_dir: str = "data/training", timeframe: str = "1m", force_rerun: bool = False
    **kwargs: Any, ) -> bool:
    ...
    try:
        ...
        if mi_top_k > 0:
                    ...
                    else: mi_quantile = float(kwargs.get("mi_quantile", 0.25))  # Keep top 75% of features (above 25th percentile)
        ...
        try: gating_dir = os.path.join(data_dir, "gating")
