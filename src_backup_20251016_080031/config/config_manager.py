...
class ConfigManager:
    ...
    def _load_configurations(self) -> None:
        ...
        self._optimizable_configs = {'confidence': get_confidence_config(), 'intensity': get_intensity_config(), 'position_sizing': get_position_sizing_config(), 'leverage': get_leverage_config(), 'tpsl': get_tpsl_config(), 'ensemble': get_ensemble_config(), 'sr': get_sr_config(), 'two_tier': get_two_tier_config(), 'technical_indicators': get_technical_indicators_config(), 'system_monitoring': get_system_monitoring_config(), 'training_optimization': get_training_optimization_config(), 'regime_transitions': get_regime_transition_config()}
        self._search_spaces = {'confidence': get_confidence_search_space(), 'intensity': get_intensity_search_space(), 'position_sizing': get_position_sizing_search_space(), 'leverage': get_leverage_search_space(), 'tpsl': get_tpsl_search_space(), 'ensemble': get_ensemble_search_space(), 'sr': get_sr_search_space(), 'two_tier': get_two_tier_search_space(), 'technical_indicators': get_technical_indicators_search_space(), 'system_monitoring': get_system_monitoring_search_space(), 'training_optimization': get_training_optimization_search_space(), 'regime_transitions': get_regime_transition_search_space()}
