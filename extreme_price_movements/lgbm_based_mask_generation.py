...
class MaskAssessor:
    ...
    def assess_rules(
        ...
        for row in selected_records:
            ...
            # Remove implicit ret_uplift or cheap_gate rejection
            # Start every candidate with reject=False per V2 spec
            rejected = False
            ...
            if not rejected:
                ...
                if subset_oof_coverage < min_oof_coverage:
                    ...
                    rejected, rejection_reason = True, "lift_less_than_or_equal_to_zero"
        ...
        # Note: 'regime_score' will be updated to 'base_regime_score' for selection
...
def select_top_diverse_rules(
    ...
    - Keep the final top 10 accepted candidates
    """
    if registry.empty:
        return registry
    ...
    for idx, row in sorted_reg.iterrows():
        ...
        # Optionally, one could filter out selection_score < 0, but for now we accept to fill top_n
