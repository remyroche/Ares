...
class IntelligentParameterPruner:
    ...
    async def _cross_validation_sensitivity_analysis(
        self,
        data: pd.DataFrame, borderline_params: List[str], parameter_mapping: Dict[str, Dict[str, Any]]
    ) -> Dict[str, float]:
    ...
    async def _detect_parameter_interactions(
        self, data: pd.DataFrame, sensitivity_scores: Dict[str, float],
    ...
    async def _evaluate_parameter_combination(
        self,
        data: pd.DataFrame, param1: str, val1: Any,
        param2: str, val2: Any
    ) -> float:
    ...
    async def _detailed_sensitivity_test(
        self,
        data: pd.DataFrame, step: str, param: str,
        param_config: Any
    ) -> float:
...
class HierarchicalOptimizer:
    ...
    async def _optimize_parameter_group_advanced(
        self, group_name: str, parameters: List[str],
