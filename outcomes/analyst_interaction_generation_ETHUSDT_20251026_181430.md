...
- 🟢 **Trend**: 20 features (Excellent)
- 🟢 **Oscillator**: 11 features (Excellent)
- 🔴 **Momentum**: 0 features (Poor)
- 🔴 **Returns**: 1 features (Poor)
- 🟢 **Volatility**: 12 features (Excellent)
...
- **Phase 1 Time**: 0.55s
- **Phase 2 Time**: 0.22s
- **Phase 3.1 Time**: 3.62s
- **Phase 3.2 Time**: 2.83s
- **Phase 3.3 Time**: 0.97s
- **Phase 4 Time**: 0.00s
- **Total Time**: 0.00s
- **Processing Efficiency**: 0.0 features/second
- **Memory Usage**: 0.0 MB
...
- **Top Interaction Examples**:
  ...
  3. `vectorbt_enhanced_ad_line_20_base_minus_fibonacci_0.618_20_price_returns_vwap` (Score: 0.0538)
  4. `vectorbt_enhanced_ad_line_20_base_div_vectorbt_parkinson_volatility_50_base` (Score: 0.0302)
  5. `vectorbt_enhanced_ad_line_20_base_x_rsi_21_returns_vwap_base` (Score: 0.0295)
...
*Generated on 2025-10-26 18:14:30*
