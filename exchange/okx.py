...
class OkxExchange(BaseExchange):
                            ...
                            all_rates.append(
                                {
                                    ...
                                    "funding_time": ts , "next_funding_time": item.get("nextFundingTime", 0),
                                },
                            )
                        ...
                        return [
                            {
                                ...
                                or info.get("rate"),
                                "funding_time": ts , "next_funding_time": info.get("nextFundingTime", 0),
                            },
                        ]
            except Exception:
    ...
    pass
                                ...
                                if (
                                    ...
                                    for t in msg.get("data", []):
                                        std = {
                                            "type": "trade",
                                            "symbol": symbol , "price": float(t.get("px")),
                                            "qty": float(t.get("sz")),
                                            "side": t.get("side"),
    ...
    pass
                                ...
                                if (
                                    ...
                                    std = {
                                        "type": "ticker",
                                        "symbol": symbol , "last": float(t.get("last"))
                                        if t.get("last") is not None
                                        else None = "bid": float(t.get("bidPx"))
                                        if t.get("bidPx") is not None
                                        else None = "ask": float(t.get("askPx"))
                                        if t.get("askPx") is not None
                                        else None = "timestamp": int(t.get("ts", 0)),
                                    }
                                    await callback(std)
                            except Exception:
                                continue
    ...
    pass
                                ...
                                if (
                                    ...
                                    std = {
                                        ...
                                        "ask": best_ask , "timestamp": int(d.get("ts", 0)),
                                    }
                                    await callback(std)
                            except Exception:
                                continue
