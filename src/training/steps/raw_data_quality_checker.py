...
class RawDataQualityChecker:
    ...
    def _fix_datetime_index(self, data: pd.DataFrame, results: dict[str, Any]) -> pd.DataFrame | None:
        ...
        try: timestamps = pd.to_datetime(data[col], format=fmt)
...
def validate_raw_data_quality(data: pd.DataFrame, symbol: str, exchange: str, config: dict[str, Any] | None, None, auto_download_missing: bool = False
) -> dict[str, Any]:
