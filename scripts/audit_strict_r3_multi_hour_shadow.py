...
SCHEMA = "strict_r3_multi_hour_shadow_audit_v1"
...
def main() -> None:
    ...
    _run([
        ...
        "--start", (start - pd.Timedelta(hours=1)).isoformat(),
    ...
    _run([
        ...
        "--candidate-start", start.isoformat(),
    ...
    for decision in decisions:
        ...
        hourly_rows.append({
            ...
            "admitted": int(auction["causal_21d_side_admitted_ge_50bps"].fillna(False).sum()),
