...
class ValidatorOrchestrator:
    ...
    async def _run_validator(self, step_name: str, training_input: dict[str, Any], pipeline_state: dict[str, Any], config: dict[str, Any], validation_level: str='CRITICAL') -> dict[str, Any]:
        ...
        validator_mapping = {
            ...
            'step14_tactician_labeling': 'tactician_model_training_validator',
            'step15_tactician_specialist_training': 'tactician_model_training_validator',
            ...
            'consolidated_backtesting': 'consolidated_backtesting_validator',
            'step18_walk_forward_validation': 'consolidated_backtesting_validator',
            'step19_monte_carlo_validation': 'consolidated_backtesting_validator',
