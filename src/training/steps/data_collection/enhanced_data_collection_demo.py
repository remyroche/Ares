...
class EnhancedDataCollectionDemo:
    ...
    async def demo_field_mappings(self) -> None:
        ...
        test_data = {'binance': {'open_time': 1640995200000, 'open': '3000.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'volume': '1000.0'}, 'coinbase': {'timestamp': 1640995200, 'price_open': '3000.0', 'price_high': '3100.0', 'price_low': '2900.0', 'price_close': '3050.0', 'volume': '1000.0'}, 'kraken': {'time': 1640995200, 'open': '3000.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'vol': '1000.0'}}
    ...
    async def demo_data_validation(self) -> None:
        ...
        klines_data = [{'open_time': 1640995200000, 'open': '3000.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'volume': '1000.0'}, {'open_time': 1640995260000, 'open': '3050.0', 'high': '3150.0', 'low': '2950.0', 'close': '3100.0', 'volume': '1200.0'}]
        ...
        aggtrades_data = [{'T': 1640995200000, 'p': '3050.0', 'q': '1.5', 'm': True}, {'T': 1640995201000, 'p': '3051.0', 'q': '2.0', 'm': False}]
        ...
        futures_data = [{'fundingTime': 1640995200000, 'fundingRate': '0.0001'}]
        ...
        invalid_data = [{'open_time': 1640995200000, 'open': '0.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'volume': '1000.0'}]
        try:
    ...
    async def demo_data_qualification(self) -> None:
        ...
        self.logger.info('-' * 50)
        test_data = [{'timestamp': 1640995200000, 'open': '3000.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'volume': '1000.0', 'exchange': 'BINANCE', 'symbol': 'ETHUSDT', 'timeframe': '1m'}, {'timestamp': 1640995200000, 'open': '3000.0', 'high': '3100.0', 'low': '2900.0', 'close': '3050.0', 'volume': '1000.0', 'exchange': 'BINANCE', 'symbol': 'ETHUSDT', 'timeframe': '1m'}, {'timestamp': 1640995260000, 'open': '3050.0', 'high': '3150.0', 'low': '2950.0', 'close': '3100.0', 'volume': '1200.0', 'exchange': 'BINANCE', 'symbol': 'ETHUSDT', 'timeframe': '1m'}]
    ...
    async def demo_api_agnostic_collection(self) -> None:
        ...
        try:
            result = await detect_and_fill_gaps(exchange='BINANCE', symbol='ETHUSDT', timeframe='1m', data_types=['klines'])
